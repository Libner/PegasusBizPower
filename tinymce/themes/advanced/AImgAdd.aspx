<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="AImgAdd.aspx.vb" Inherits="bizpower_pegasus2018.AImgAdd" %>
		...
		<form id="form1" runat="server" method="post" ENCTYPE="multipart/form-data">
			...
			<p>
				<asp:RegularExpressionValidator id="valPicFile" runat="server" CssClass="validator" ErrorMessage="אנא בחר קובץ תמונה חוקי"
					Display="Dynamic" ControlToValidate="UploadFile1" ValidationExpression="^.+\.(([jJ][pP][eE]?[gG])|([gG][iI][fF])|([pP][nN][gG]))$"></asp:RegularExpressionValidator>
			</p>
