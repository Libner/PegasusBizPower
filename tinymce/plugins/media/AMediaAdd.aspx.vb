...
Public Class AMediaAdd
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        str_mappath = Application("VirDir") & "/download/media"
        ...
        If Request.Files.Count > 0 And Page.IsValid Then
            ...
            If Request.Files("UploadFile1").ContentLength > 0 Then
                ...
                Dim scrp As String = "<SCRIPT LANGUAGE=javascript>" & vbCrLf & _
                   "<!--" & vbCrLf & _
                   "   window.opener.document.getElementById('" & field_name & "').value = '" & "http://" & Request.ServerVariables("Server_name") & str_mappath & "/" & strFileName & "';" & vbCrLf & _
                   "   self.close(); " & vbCrLf & _
                   "//-->" & vbCrLf & _
                   "</SCRIPT>"
