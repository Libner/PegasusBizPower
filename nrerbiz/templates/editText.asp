...
<table bgcolor="#c0c0c0" border="0" width="100%" cellspacing="0" cellpadding="0">
  <tr>
    <td colspan="5" class="page_title">עדכון טקסט דיוור</td>
  </tr> 
</table>
...
<table border="0" width="100%" align="center" cellspacing="1" cellpadding="0" bgcolor="#FFFFFF">
  <tr>
    <td align="center" valign="middle" bgcolor="#3E596E" nowrap height=20 class="small_table_header">טקסט</td>
  </tr>
<tr>
...
<tr>
 ...
 <%if (linkStatus<>"noLink" and elemId<>nil) then
  ...
  <tr>
  	...
  	<tr><td colspan="4" align="center" bgcolor="#3E596E" height=20 class="small_table_header">קישור</td></tr>
  ...
  <tr>
	...
	<td width="20%" bgcolor="#DDDDDD" valign="top" nowrap>
		<table bgcolor="#DDDDDD" border="0" cellspacing="0" cellpadding="0" width="100%">
			<tr><td align="center" bgcolor="#3E596E" height=20 class="small_table_header">יישור</td></tr>
			<tr>
    ...
    <option value="<%=i%>" <%if persize=i then%>selected<%end if%>><%=i%></option>
			...
			<!--tr>
				...
				<td align="left" bgcolor="#DDDDDD" class="form">&nbsp;:הרושה ךרוא</td>
			</tr-->
		</table>	
	</td>			
			</tr>
...
<tr>
	...
	<td width="50%" valign="top">
		<table bgcolor="#DDDDDD" border="0" cellspacing="0" cellpadding="0" width="100%" height="100%">
			...
			<tr>
				<td width="25%" bgcolor="#DDDDDD" align="right" nowrap><img src="../../bullets/bul3.gif" border="0">&nbsp;<input type="radio" name="bullet" value="3" <%if pBullet="3" then%>checked<%end if%>></td>
				<td width="25%" bgcolor="#DDDDDD" align="right" nowrap><img src="../../bullets/bul2.gif" border="0">&nbsp;<input type="radio" name="bullet" value="2" <%if pBullet="2" then%>checked<%end if%>></td>
				<td width="25%" bgcolor="#DDDDDD" align="right" nowrap><img src="../../bullets/bul1.gif" border="0">&nbsp;<input type="radio" name="bullet" value="1" <%if pBullet="1" then%>checked<%end if%>></td>
				<td width="25%" bgcolor="#DDDDDD" align="right" class="10normalB" valign="top" nowrap>ללא תבליטים&nbsp;<input type="radio" name="bullet" value="0" <%if isNull(pBullet) or pBullet="0" then%>checked<%end if%>></td>
			</tr>
			<tr>
				<td width="25%" bgcolor="#DDDDDD" align="right" nowrap><img src="../../bullets/bul7.gif" border="0" >&nbsp;<input type="radio" name="bullet" value="7" <%if pBullet="7" then%>checked<%end if%>></td>
				<td width="25%" bgcolor="#DDDDDD" align="right" nowrap><img src="../../bullets/bul6.gif" border="0" >&nbsp;<input type="radio" name="bullet" value="6" <%if pBullet="6" then%>checked<%end if%>></td>
				<td width="25%" bgcolor="#DDDDDD" align="right" nowrap><img src="../../bullets/bul5.gif" border="0" >&nbsp;<input type="radio" name="bullet" value="5" <%if pBullet="5" then%>checked<%end if%>></td>
				<td width="25%" bgcolor="#DDDDDD" align="right" nowrap><img src="../../bullets/bul4.gif" border="0" >&nbsp;<input type="radio" name="bullet" value="4" <%if pBullet="4" then%>checked<%end if%>></td>
			</tr>
			<tr>
				<td width="25%" bgcolor="#DDDDDD" align="right" nowrap><img src="../../bullets/bul11.gif" border="0" >&nbsp;<input type="radio" name="bullet" value="11" <%if pBullet="11" then%>checked<%end if%>></td>
				<td width="25%" bgcolor="#DDDDDD" align="right" nowrap><img src="../../bullets/bul10.gif" border="0" >&nbsp;<input type="radio" name="bullet" value="10" <%if pBullet="10" then%>checked<%end if%>></td>
				<td width="25%" bgcolor="#DDDDDD" align="right" nowrap><img src="../../bullets/bul9.gif" border="0" >&nbsp;<input type="radio" name="bullet" value="9" <%if pBullet="9" then%>checked<%end if%>></td>
				<td width="25%" bgcolor="#DDDDDD" align="right" nowrap><img src="../../bullets/bul8.gif" border="0" >&nbsp;<input type="radio" name="bullet" value="8" <%if pBullet="8" then%>checked<%end if%>></td>
			</tr>
			<tr>
				<td width="25%" bgcolor="#DDDDDD" align="right" nowrap><img src="../../bullets/bul15.gif" border="0" >&nbsp;<input type="radio" name="bullet" value="15" <%if pBullet="15" then%>checked<%end if%>></td>
				<td width="25%" bgcolor="#DDDDDD" align="right" nowrap><img src="../../bullets/bul14.gif" border="0" >&nbsp;<input type="radio" name="bullet" value="14" <%if pBullet="14" then%>checked<%end if%>></td>
				<td width="25%" bgcolor="#DDDDDD" align="right" nowrap><img src="../../bullets/bul13.gif" border="0" >&nbsp;<input type="radio" name="bullet" value="13" <%if pBullet="13" then%>checked<%end if%>></td>
				<td width="25%" bgcolor="#DDDDDD" align="right" nowrap><img src="../../bullets/bul12.gif" border="0" >&nbsp;<input type="radio" name="bullet" value="12" <%if pBullet="12" then%>checked<%end if%>></td>
			</tr>		
			<tr>
				<td width="25%" bgcolor="#DDDDDD" align="right" nowrap><img src="../../bullets/bul19.gif" border="0" >&nbsp;<input type="radio" name="bullet" value="19" <%if pBullet="19" then%>checked<%end if%>></td>
				<td width="25%" bgcolor="#DDDDDD" align="right" nowrap><img src="../../bullets/bul18.gif" border="0" >&nbsp;<input type="radio" name="bullet" value="18" <%if pBullet="18" then%>checked<%end if%>></td>
				<td width="25%" bgcolor="#DDDDDD" align="right" nowrap><img src="../../bullets/bul17.gif" border="0" >&nbsp;<input type="radio" name="bullet" value="17" <%if pBullet="17" then%>checked<%end if%>></td>
				<td width="25%" bgcolor="#DDDDDD" align="right" nowrap><img src="../../bullets/bul16.gif" border="0" >&nbsp;<input type="radio" name="bullet" value="16" <%if pBullet="16" then%>checked<%end if%>></td>
			</tr>
		</table>
		</td>
	  </tr>
