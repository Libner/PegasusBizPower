...
// Note: Script consists of two files: calendar?.js and calendar.asp
...
function cal_popup2 (str_datetime) {
	...
	var obj_calwindow = window.open(
		'calendar.asp?datetime=' + this.dt_current.valueOf()+ '&id=' + this.id,
...
function cal_gen_time2 (dt_datetime) {
	return (
		...
		+ (dt_datetime.getMinutes() < 10 ? '0' : '') + (dt_datetime.getMinutes()) + ":00"
	);
}
