...
var ARR_MONTHS = ["ינואר","פברואר","מרץ","אפריל",
    					"מאי","יוני","יולי","אוגוסט",
						"ספטמבר","אוקטובר","נובמבר","דצמבר"];                //var ARR_MONTHS = ["January", "February", "March", "April", "May", "June",
		//"July", "August", "September", "October", "November", "December"];		
// week day titles as they appear on the calendar
var ARR_WEEKDAYS = ["א", "ב", "ג", "ד", "ה", "ו", "שבת"];    //var ARR_WEEKDAYS = ["Su", "Mo", "Tu", "We", "Th", "Fr", "Sa"];
...
if (obj_caller && obj_caller.time_comp)
	document.write('<form onsubmit="javascript:set_datetime('+dt_current.valueOf()+', true)" name="cal"><tr><td colspan="7" bgcolor="#87CEFA" align="right"><font color="White" face="tahoma, verdana" size="2"><input dir="rtl" type="text" name="time" value="'+obj_caller.gen_time(this.dt_current) +'" size="8" maxlength="8"> : שעה</font></td></tr></form>');
</script>
</table></tr></td>
</table>
</body>
