...
strInputName = ConvertBinaryToString(MidB(binData,lngBeginningPos,lngEndPos-lngBeginningPos))
		...
		lngEOF = InstrB(lngEndPos,binData,strSeparator)
			...
			lngEndPos = InstrB(lngBeginningPos,binData,strSeparator) - 2
				...
				Form.Add strInputName,ConvertBinaryToString(MidB(binData,lngBeginningPos,lngEndPos-lngBeginningPos))
				END IF
