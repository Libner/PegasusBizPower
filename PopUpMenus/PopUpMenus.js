...
function setMenuTree(isChild,parMenu) {
	if (!isChild) {
		...
		this.menuLeft = getX(document.all(this.array[1]))+this.array[3];
		//alert(getY(document.all(this.array[1])));
		//this.menuTop = this.array[2];		
		this.menuTop = getY(document.all(this.array[1]))+this.array[2];			
		this.menuFontColor = this.array[4] ? this.array[4] : fntCol;
		//alert(this.menuFontColor)
		//this.menuFontColor=fntCol;
		this.menuFontOver = this.array[5] ? this.array[5] : overFntColor;
		//alert(this.array[8])
		
		this.menuBGColor = this.array[6] ? this.array[6] : backColor;
		this.menuBGOver = this.array[7] ? this.array[7] : overColor;
		
		this.menuBorCol = borderCol;
		this.menuSeparatorCol = separatorColor;
