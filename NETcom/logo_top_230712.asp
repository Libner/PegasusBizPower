...
<tr><td><iframe id=checkMess src=http://pegasus.bizpower.co.il//NETcom/members/messages/checkNewMessagesWindow.aspx frameborder="0" height="0"></iframe></td></tr>
    <%end  if%>
    <tr>
      <td width="100%" valign="bottom" height="79">
      <table border="0" width="100%" style="height: 66px"  cellspacing="0" cellpadding="0">
        <tr>
          <td valign="top" align="center" width="100%" height="62"><%if false then%><iframe src="<%=Application("VirDir")%>/netCom/info.aspx" 
          width="766" height="62" frameborder="0" ></iframe><%end if%></td>
