Public Class top_in_webflowCSS
...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        While rs_obj.Read()
            ...
            '!!!!!!!!!!!from 03/10/2019 - select by bar_Id parent and not BY ORDER
        ...
        For i = 0 To UBound(arr_bars_top, 2) - 1
            ...
            If Trim(barVisible) = "1" Then
                ...
                dis = ""
                strPH += "<a " & href & dis & " target=_self class='bizlink_level_1"
                    If Trim(barID) = Trim(numOfTab + 1) Then
                        strPH += " current"
                    End If
                strPH += " w-inline-block'>"
                strPH += "<div>" & barTitle & "</div>"
                strPH += "</a>"
        ...
        For j = 0 To UBound(arr_bars, 2) - 1
            ...
            If CInt(barParent) = CInt(numOfTab) + 1 Then
                If Trim(barVisible) = "1" Then
                    ...
                    href = "href='" & barURL & "' "
                    dis = ""
                    strPH += "<a " & href & dis & " target='_self' class='bizlink_level_2"
                    If topLevel2 <> "0" Then
