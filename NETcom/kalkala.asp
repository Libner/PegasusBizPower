    ...
    width="76%" cellspacing="0" cellpadding="0" ID="Table7">
     ...
     <tr>
      ...
      <tr>
				...
				<tr>
					...
					<table border="0" width="100%" cellspacing="0" cellpadding="0" ID="Table11">
						...
						<tr>
							...
							<span  class="subtitle">כדי לבדוק את עלות הפרויקטים של החברה 
							</span>
		...
		<tr><td height="5"></td></tr>
		<tr><td width="100%" align="right" dir="rtl"><b>
		ג.	הזן את הפרויקטים / הפרויקטים  הפעילים בחברה שלך.
		</b></td></tr>
		<tr><td width="100%" align="right" dir="rtl" style="padding-right:20px">
		1.	<a href="members/projects/default.asp" style="font-size:10pt;text-decoration:underline" class="home_link" target=_self>הזן את הפרויקטים / הפרויקטים  הפעילים בחברה שלך</a>
		</td></tr>
		<tr><td height="10"></td></tr>
		</table></td></tr>
		<tr><td width="100%" align="right" dir="rtl">
		<span class="subtitle">הפץ לעובדיך את פרטי הכניסה</span> שלהם למערכת ( שם משתמש וסיסמה ) לצורך איסוף שעות העבודה שלהם .  השעות התווספו לפי פרויקט ושם ארגון כפי שהוגדרו מעלה.
		</td></tr>		
	</table></td></tr>						
    <tr><td height="5"></td></tr>
    </table></td>
