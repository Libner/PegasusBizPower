<%@ Control Language="vb" AutoEventWireup="false" Codebehind="logo_top.ascx.vb" Inherits="bizpower_pegasus.logo_top" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
<%if ShowLogo = "1" then%>
...
<table border="0" width="100%" cellspacing="0" cellpadding="0" dir="ltr">
	<tr>
        ...
        <tr>
          <td valign="top" align="center" width="100%" height="62"><iframe src="<%=Application("VirDir")%>/netCom/info_new.aspx" 
          ...
          style="background-image:URL('<%=Application("VirDir")%>/images/exit<%=img_%>.gif');background-position:<%=bgr_pos%>;background-repeat:'no-repeat';">
            <tr>
              <!--td><a href="<%=Application("VirDir")%>" target=_self><img src="<%=Application("VirDir")%>/images/exit.gif"></a></td-->              
              <td width="201" nowrap height="21"><a href="<%=Application("VirDir")%>" target=_self>             
