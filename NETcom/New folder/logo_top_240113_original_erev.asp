...
<tr><td><%'If false then%><iframe id=checkMess src=http://pegasus.bizpower.co.il/NETcom/members/messages/checkNewMessagesWindow.aspx frameborder="0" height="0"></iframe><%'end if%></td></tr>
    <%'end  if%>
    <tr>
