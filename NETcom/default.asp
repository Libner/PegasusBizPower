...
<table border="0" width="100%" bgcolor="#FFFFFF" cellspacing="0" cellpadding="0">        
   ...
   <tr><td align=center>
    <iframe src="<%=Application("VirDir")%>/netCom/members/orders_check/img_graphMonthly.aspx?UserId=<%=UserID%>" 
          width="1300" height="700" frameborder="0" ></iframe>
