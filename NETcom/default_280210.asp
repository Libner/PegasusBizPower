   ...
   while not tasksList.EOF       
     ...
     %>
        <tr height=18>
		  ...
		  <input type=image src="images/hets4.gif" border=0 hspace=0 vspace=0 onclick='window.open("members/tasks/task_history.asp?taskID=<%=taskID%>", "" ,"scrollbars=1,toolbar=0,top=50,left=10,width=<%=cInt(strScreenWidth*0.97)%>,height=480,align=center,resizable=0");' ID="Image3" NAME="Image1">
		  <%End If%>
		  <%If trim(parentID) <> "" And trim(taskID) <> "" Then%>
		  <input type=image src="images/hets4a.gif" border=0 hspace=0 vspace=0 onclick='window.open("members/tasks/task_history.asp?taskID=<%=taskID%>", "" ,"scrollbars=1,toolbar=0,top=50,left=10,width=<%=cInt(strScreenWidth*0.97)%>,height=480,align=center,resizable=0");' ID="Image9" NAME="Image4">
		  <%End If%>
		</td>        
   ...
   If not tasksList.eof Then
       ...
       %>
        <tr height=18>
            <td align=center class="card<%=class_%>" valign=middle>
			<%If trim(taskID) <> "" And trim(childID) <> "" Then%>
			<input type=image src="images/hets4.gif" border=0 hspace=0 vspace=0 onclick='window.open("members/tasks/task_history.asp?taskID=<%=taskID%>", "" ,"scrollbars=1,toolbar=0,top=50,left=10,width=<%=cInt(strScreenWidth*0.97)%>,height=480,align=center,resizable=0");' ID="Image10" NAME="Image1">
			<%End If%>
			<%If trim(parentID) <> "" And trim(taskID) <> "" Then%>
			<input type=image src="images/hets4a.gif" border=0 hspace=0 vspace=0 onclick='window.open("members/tasks/task_history.asp?taskID=<%=taskID%>", "" ,"scrollbars=1,toolbar=0,top=50,left=10,width=<%=cInt(strScreenWidth*0.97)%>,height=480,align=center,resizable=0");' ID="Image11" NAME="Image4">
			<%End If%>
			</td>
