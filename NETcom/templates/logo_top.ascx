<%@ Control Language="vb" AutoEventWireup="false" Codebehind="logo_top.ascx.vb" Inherits="bizpower_pegasus2018.logo_top" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
<%if ShowLogo = "1" then%>
