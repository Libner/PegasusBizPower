...
<%
	...
	End If		
%>
<table background="<%=strLocal%>/netcom/templates/images/top3&#46;gif" border="0" width="620" cellspacing="0" cellpadding="0" height="70" nowrap>
  <tr>
    <td width="620" valign="top" align="right">
