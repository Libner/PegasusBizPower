...
<%
	...
	If isNumeric(perSize2) = True Then
		perSize2 = cInt(perSize2)
	Else
		perSize2 = 0
	End If			
%>
<table background="<%=strLocal%>/netcom/templates/images/top4&#46;gif" border="0" width="620" cellspacing="0" cellpadding="0" height="80">
  <tr>
    <td width="620" valign="top">
    <%If isNumeric(pageId) And perSize2 > 0 Then%>
