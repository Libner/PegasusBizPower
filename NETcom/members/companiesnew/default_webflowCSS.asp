<!-- מסך ראשי של מודול קשרי לקוחות, כולל כפתור הוסף איש קשר, ייבוא אנשי קשר, צרף טופס ו IFRAME חיפוש  -->
<%@ LANGUAGE=VBScript %>
...
<tr>    
   ...
   <%Else%> src="contacts.asp?search_contact=<%=Server.URLEncode(search_contact)%>" <%End If%>
	ALLOWTRANSPARENCY=true height=800 width="100%" marginwidth="0" marginheight="0" hspace="0" vspace="0" scrolling="0" frameborder="0"></iframe>
    </td>
