...
<tr>          
    ...
    <%sqlstr = "EXEC dbo.appeals_contact_form " & ContactId
		...
		<tr bgcolor="<%=tr_bgcolor%>" onmouseover="this.style.backgroundColor='#B1B0CF';" onmouseout="this.style.backgroundColor='<%=tr_bgcolor%>';">
			...
			<td align="<%=align_var%>" dir="<%=dir_var%>" ><%=rs_hf("40624")%></td>
...
<tr>
  ...
  <table cellpadding=0 cellspacing=0 width="100%" dir="<%=dir_var%>">
  <tr>  
  <td class="title_form" width="350" nowrap><a style="color: #ffd011; text-decoration: none;" href="javascript:void(0)" onclick="window.open('../appeals/contact_appeals.asp?contactID=<%=contactID%>','winCA','top=20, left=20, width=900, height=500, scrollbars=1');" >&nbsp;<b>היסטוריה ושינויים בטפסים</b>&nbsp;<img 
