...
<!--
		...
		function doSearch()
		{
			var searchCellular = new String(document.getElementById("search_cellular").value);
  ...
  <tr>
    ...
    <table width="100%" cellspacing="1" cellpadding="1" border=0 bgcolor="#ffffff" >
		...
		<td width="150" nowrap class="title_sort" align="right" dir="rtl"><input type="text" class="search" dir="rtl" style="width:148px;" value="<%=vFix(search_email)%>" name="search_email" ID="search_email" onkeypress="return entsubsearchg(event);"></td>  		
  		<td width="72" nowrap class="title_sort" align="right" dir="rtl"><input type="text" class="search" dir="rtl" style="width:70px;" value="<%=vFix(search_cellular)%>" name="search_cellular" ID="search_cellular" onkeypress="return entsubsearchg(event);"></td>
		<td width="75" nowrap class="title_sort" align="right" dir="rtl"><input type="text" class="search" dir="rtl" style="width:73px;" value="<%=vFix(search_phone)%>" name="search_phone" ID="search_phone" onkeypress="return entsubsearchg(event);"></td>
...
<%
if sFix(search_contact)<>"" or sFix(search_email)<>"" or sFix(search_company)<>"" or sFix(search_city_Name)<>"" or sFix(search_messanger_name) <>"" or  sFix(search_phone)<>"" or sFix(search_cellular)<>"" then
sqlSelect = "Exec dbo.get_company_contacts @Page=" & Page & ", @RecsPerPage=" & PageSize & ", @OrgID=" & OrgID & _
    ...
    For cc=0 To Ubound(arr_conts,2)
	  ...
	  %>
	  <tr>
		<td width="100%" align=middle colspan="9" nowrap bgcolor="#e6e6e6" dir=ltr>
	...
	<%	End if	%>
	<tr>
	   <td colspan="9" height=18 bgcolor="#e6e6e6" align=center class="card" dir="ltr" style="color:#6E6DA6;font-weight:600"><!--נמצאו--><%=arrTitles(8)%>&nbsp;<%=recCount%>&nbsp;<%=trim(Request.Cookies("bizpegasus")("ContactsMulti"))%></td>
	</tr>
	<% 
	Else %>
	<tr>
	   <td colspan="9" align=center class="title_sort1" dir="rtl"><!--לא נמצאו--><%=arrTitles(9)%>&nbsp;<%=arrTitles(23)%></td>
	</tr>
