...
<html>
<head>
<!-- #include file="../../title_meta_inc_webflowCSS.asp" -->
...
<!--#include file="../../logo_top_WebflowCSS.asp"-->
</td></tr>
<tr><td width=100% align="<%=align_var%>">
  <%numOftab = 4%>
  <%numOfLink = 0%>
<!--#include file="../../top_in_WebflowCSS.asp"-->
</td></tr>
...
<tr>
	...
	<td width="100%" align="<%=align_var%>" class="title_sort">&nbsp;<span id="word5" name=word5><!--קבוצה--><%=arrTitles(5)%></span>&nbsp;</td>	
</tr>
...
<tr><td nowrap colspan=2 align="center"><a class="button_edit_1" style="width:100;"  href='#' OnClick="return opencontact_type('')"><span id=word6 name=word6><!--הוספת קבוצה--><%=arrTitles(6)%></span></a></td></tr>
<tr><td nowrap colspan=2 align="center"><a class="button_edit_1" style="width:100;"  href="excel_types.asp" target=_blank><!--הצג דוח--><%=arrTitles(7)%></a></td></tr>
...
<tr><td height=10 nowrap></td></tr>
  ...
  <script src="<%=Application("VirDir")%>/NETcom/webflowCSS/js/webflow.js" type="text/javascript"></script>
