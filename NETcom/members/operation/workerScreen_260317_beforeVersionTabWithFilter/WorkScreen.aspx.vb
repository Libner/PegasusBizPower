...
Public Class WorkScreen
    ...
    Protected pcodeTiul, pdateTiul, pGilboaHotel, pisSendLetterGroupMeeting, pisSendToGuide, pisSendTicket, pVoucher_Simultaneous, pVoucher_Group, pDeparture_Costing, pVouchers_Provider, pStatus, sortQuery, sortQuery1, qrystring As String
    Protected UsersSelect, SeriesSelect, SuppliersSelect, StatusSelect, GuidesSelect, Vouchers_ProviderSelect As System.Web.UI.HtmlControls.HtmlInputHidden
...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        '   Request.Cookies("bizpegasus")("Chief")
    ...
    Public Sub bindList()
        ...
        Else
            ...
            'End If
            'Response.Write("bb=" & SuppliersSelect.Value)
            '  Response.End()
