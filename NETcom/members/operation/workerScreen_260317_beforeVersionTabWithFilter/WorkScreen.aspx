					...
					<td valign="top" align="left">
						<table cellpadding="1" cellspacing="1" width="100%" align="left" style="border:solid 1px #d3d3d3">
							<tr bgcolor="#d8d8d8" style="height:25px">
								...
								<Td class="title_sort" style="width:45px" valign="bottom" align=center><select id="sGilboaHotel" name="s" dir="rtl" class="searchList"><option value="בחר">בחר</option>
							...
							<asp:Repeater ID="rptData" Runat="server">
								...
								<tr style="background-color: rgb(201, 201, 201);height:45px" class=horizontal>
										...
										<td align="center" style="width:30px;height:45px">
											<div class="div1">
												<a href="#"   style="color:#000000;text-decoration:none;vertical-align:middle" onclick="window.open('GuideMessages.asp?dID=<%#Container.DataItem("Departure_Id")%>','winCA','top=20, left=10, width=1200, height=800, scrollbars=1');">
