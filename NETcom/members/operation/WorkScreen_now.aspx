...
{
//alert("save")
	if (document.getElementById("TimeMeetingAfterTrip_text"+no).value.trim()!='')
		{
		...
		if (document.getElementById("DepartureTimeBrief_text"+no).value.trim()!='')
		{
			...
			if (document.getElementById("Departure_TimeGroupMeeting_text"+no).value.trim()!='')
		{
						...
						<table cellpadding="1" cellspacing="1" width="100%" align="left" style="border:solid 1px #d3d3d3">
							<tr bgcolor="#d8d8d8" style="height:25px">
								...
								<Td class="title_sort" style="width:60px" valign="bottom" align=center>
									<a href="#"  onclick="SelectVouchers_Provider('');return false" class="link1"><img src=../../images/<%if Vouchers_ProviderSelect.Value<>"" and Vouchers_ProviderSelect.Value<>"0" then%>select_act.png<%else%>select.png<%end if%> width=20 border=0 id="SelectVouchers_ProviderAlt" title="<%'=func.GetSelectStatusName(StatusSelect.Value)%>"></a>
								...
								<a href="#"  onclick="SelectGuides('');return false" class="link1"><img src=../../images/<%if GuidesSelect.Value<>"" and GuidesSelect.Value<>"0" then%>select_act.png<%else%>select.png<%end if%> width=20 border=0 id="SelectGuidesAlt" title="<%=func.GetSelectGuidesName(GuidesSelect.Value)%>"></a>
							...
							<%if false then%><select runat="server" id="sSeries" class="searchList" dir="rtl" name="sSeries" style="width:40px"></select><%end if%></td>
								<Td class="title_sort" width="45px" valign="bottom" align=center><%If Request.Cookies("bizpegasus")("Chief") = "1" Then%>
							...
							<asp:Repeater ID="rptData" Runat="server">
										...
										<td align="center" style="height:45px">
											<div class="div1">
												<div id="supplier_Id_<%#Container.DataItem("Departure_Id")%>"  class="div2">
													-<%#func.sFix(Container.DataItem("supplier_Id").ToString())%>-
 
														<%#IIf(IsDBNull(DataBinder.Eval(Container.DataItem, "supplier_Id")),"&nbsp;", "<img src=../../images/v.png width=15 title="& func.GetSelectSupplierName(func.sFix(Container.DataItem("supplier_Id")))&">")%>
												</div>
												<div id="supplier_Id_row<%#Container.DataItem("Departure_Id")%>" style="display:none;">
													<a href="#"  onclick="SelectSupplier('<%#Container.DataItem("Departure_Id")%>','<%#func.vfix(Container.DataItem("Departure_Code"))%>');return false" class="link1">
																-<%#func.vFix(Container.DataItem("supplier_Id"))%>-<%#IIF(func.sFix(Container.DataItem("supplier_Id"))="","<img src=""../../images/select.png"" border=""0"" width=""20"">", "<span style=font-size:12px;font-weight:bold>V</span>")%>
											</a>
												</div>
											</div>
										</td>
								...
								<AlternatingItemTemplate>
									<tr style="background-color: rgb(230, 230, 230);height:45px" id="row<%#Container.DataItem("Departure_Id")%>">
										...
										<div class="div1">
												<div id="supplier_Id_<%#Container.DataItem("Departure_Id")%>"  class="div2">
														<%#IIF(IsDBNull(Container.DataItem("supplier_Name")),"&nbsp;", "<span style=font-size:12px;font-weight:bold>V</span>")%>
												</div>
												<div id="supplier_Id_row<%#Container.DataItem("Departure_Id")%>" style="display:none;">
													<a href="#"  onclick="SelectSupplier('<%#Container.DataItem("Departure_Id")%>','<%#func.vfix(Container.DataItem("Departure_Code"))%>');return false" class="link1">
														<%#IIF(IsDBNull(Container.DataItem("supplier_Name")),"<img src=""../../images/select.png"" border=""0"" width=""20"">", "<span style=font-size:12px;font-weight:bold>V</span>")%>
														</a>
												</div>
											</div>
										</td>
