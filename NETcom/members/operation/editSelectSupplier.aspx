<%@ Page Language="vb" AutoEventWireup="false" Codebehind="editSelectSupplier.aspx.vb" Inherits="bizpower_pegasus2018.editSelectSupplier" %>
							...
							<ItemTemplate>
								<table border="0" cellpadding="2" cellspacing="2">
									<tr>
										...
										<td align="right" valign="top"><input type="checkbox" ID="chkSpec" Runat="server" style="float:right" NAME="chkSpec"></td>
									</tr>
									<tr>
				...
				<tr>
					<td align="center" class="td_admin_4">
						<table border="0" cellpadding="5" cellspacing="0">
							<tr>
								<td align="center" class="td_admin_4">
									<asp:Button id="btnCancel" BackColor="#FF9100" Font-Bold="True" Font-Name="Arial" Font-Size="10pt"
										ForeColor="#FFFFFF" EnableViewState="false" runat="server" Text="לבטל שיוך"></asp:Button></td>
								<td align="center" class="td_admin_4">
