...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If Request("GuidesSelectH") <> "" Then
            pisGuideStatus = Request("sGuideStatusH")
        Else
            pisGuideStatus = ""
        End If
        ...
        XLSfile.Append("<td class=xl25>סטטוס המדריך</td>")
    ...
    Sub GetdataList()
        ...
        cmdSelect.Parameters.Add("@pisGuideStatus", SqlDbType.VarChar, 5).Value = pisGuideStatus
        ...
        While dr.Read()
            ...
            XLSfile.Append("<td class=xl26>") : XLSfile.Append(dr("GuideStatusName")) : XLSfile.Append("</td>")
