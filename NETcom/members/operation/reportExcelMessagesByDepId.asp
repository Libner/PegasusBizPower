...
<%  Session.LCID = 1037
   ...
   Dim strXLS
	...
	strXLS.Add  "<body>"
     	...
     	sql = "Exec dbo.[get_GuideMessagesExcel] "& nFix(dID)
 ...
 strXLS.Add  "<table style='border-collapse:collapse;table-layout:fixed' dir=" : strXLS.Add dir_var  : strXLS.Add ">"  
    strXLS.Add  "<tr style='background:#808080;color:#ffffff'><td colspan=8 align=right class=xl24 style='background:#808080;color:#ffffff'>"  : strXLS.Add rsa("Departure_Code") : strXLS.Add " דוח פירוט שיחות לטיול " : strXLS.Add "</td></tr>"
...
strXLS.Add "</tr>"
 ...
 Loop
	...
	filestring = "MessagesExcelByDId.xls"
    Response.Clear()
