...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Else
            ...
            If ss = "0" Then
                cScript = "<script language='javascript'>opener.document.getElementById('StatusSelect').value = '" & Replace(ss, "'", "&#" & AscW(Chr(39)) & ";") & "'; opener.document.getElementById('SelectStatusAlt').src='../../images/select.png';opener.document.getElementById('SelectStatusAlt').title='" & ssName & "';self.close(); </script>"

            Else
                cScript = "<script language='javascript'>opener.document.getElementById('StatusSelect').value = '" & Replace(ss, "'", "&#" & AscW(Chr(39)) & ";") & "'; opener.document.getElementById('SelectStatusAlt').src='../../images/select_act.png';opener.document.getElementById('SelectStatusAlt').title='" & ssName & "';self.close(); </script>"
    ...
    Sub getStatus()
        ...
        Dim list2 As New ListItem("בחול", "כן")
        fselect.Items.Insert(1, list2)
        Dim list3 As New ListItem("חזר", "חזר")
        fselect.Items.Insert(2, list3)
        Dim list4 As New ListItem("עתידי", "עתידי")
