...
DepartureId=request.QueryString("dID")
 ...
 if trim(sort_app)="" then  sort=0 end if  
  ...
  <tr>
    ...
    <tr style="height:35px">
	    <td width="100%" nowrap class="title_sort" dir="<%=dir_obj_var%>" align="center">פרוט</td>
			<td width="110"  nowrap align="center" dir="<%=dir_obj_var%>" class="title_sort<%if sort_app=5 or sort_app=6 then%>_act<%end if%>"><a class="title_sort" name=word25 title="מיון" HREF="<%=urlSort%>&sort_app=<%if sort_app=6 then%>5<%elseif sort_app=5 then%>6<%else%>6<%end if%>" target="_self">&nbsp;שם משתמש&nbsp;<img src="../../images/arrow_<%if trim(sort_app)="5" then%>down<%elseif trim(sort_app)="6" then%>up<%else%>grey<%end if%>.gif" width="9" height="6" border="0" hspace="2"></a></td>	
	
		<td width="110"  nowrap align="center" dir="<%=dir_obj_var%>" class="title_sort<%if sort_app=5 or sort_app=6 then%>_act<%end if%>"><a class="title_sort" name=word25 title="מיון" HREF="<%=urlSort%>&sort_app=<%if sort_app=6 then%>5<%elseif sort_app=5 then%>6<%else%>6<%end if%>" target="_self">&nbsp;<!--עובד-->שעת השיחה&nbsp;<img src="../../images/arrow_<%if trim(sort_app)="5" then%>down<%elseif trim(sort_app)="6" then%>up<%else%>grey<%end if%>.gif" width="9" height="6" border="0" hspace="2"></a></td>	
		<td align="center" dir="<%=dir_obj_var%>" class="title_sort" <%if sort_app=3 or sort_app=4 then%>_act<%end if%>" nowrap><a class="title_sort" HREF="<%=urlSort%>&productID=<%=productID%>&sort_app=<%if sort_app=4 then%>3<%elseif sort_app=3 then%>4<%else%>4<%end if%>#table_appeals" target="_self">&nbsp;תאריך שיחה&nbsp;<img src="../../images/arrow_<%if trim(sort_app)="3" then%>bot<%elseif trim(sort_app)="4" then%>top<%else%>grey<%end if%>.gif" width="9" height="6" border="0" hspace="2"></a></td>				
		<td width="80" nowrap align="center" dir="<%=dir_obj_var%>" class="title_sort<%if sort_app=3 or sort_app=4 then%>_act<%end if%>" nowrap><a class="title_sort" HREF="<%=urlSort%>&productID=<%=productID%>&sort_app=<%if sort_app=4 then%>3<%elseif sort_app=3 then%>4<%else%>4<%end if%>#table_appeals" target="_self">&nbsp;מדריך&nbsp;<img src="../../images/arrow_<%if trim(sort_app)="3" then%>bot<%elseif trim(sort_app)="4" then%>top<%else%>grey<%end if%>.gif" width="9" height="6" border="0" hspace="2"></a></td>
		<td width="80"  align="center" dir="<%=dir_obj_var%>" class="title_sort<%if sort_app=1 or sort_app=2 then%>_act<%end if%>" nowrap><a class="title_sort" HREF="<%=urlSort%>&productID=<%=productID%>&sort_app=<%if sort_app=2 then%>1<%elseif sort_app=1 then%>2<%else%>2<%end if%>#table_appeals" target="_self">&nbsp;<!--תאריך-->קוד טיול&nbsp;<img src="../../images/arrow_<%if trim(sort_app)="1" then%>bot<%elseif trim(sort_app)="2" then%>top<%else%>grey<%end if%>.gif" width="9" height="6" border="0" hspace="2"></a></td>			
		<td width="80" nowrap align="center" dir="<%=dir_obj_var%>" class="title_sort<%if sort_app=11 or sort_app=12 then%>_act<%end if%>" nowrap><a class="title_sort" HREF="<%=urlSort%>&productID=<%=productID%>&sort_app=<%if sort_app=12 then%>11<%elseif sort_app=11 then%>12<%else%>12<%end if%>#table_appeals" target="_self">&nbsp;<!--'סט-->תאריך&nbsp;<img src="../../images/arrow_<%if trim(sort_app)="11" then%>bot<%elseif trim(sort_app)="12" then%>top<%else%>grey<%end if%>.gif" width="9" height="6" border="0" hspace="2"></a></td>
