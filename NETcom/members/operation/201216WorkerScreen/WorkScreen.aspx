...
<tr bgcolor=#d8d8d8 style="height:45px" >
	...
	<td class="title_sort" align=center dir=rtl>שובר<br>לסימולטני?</td>
	<td class="title_sort" align=center dir=rtl>הוקלדו<br>מלונות<br>בגלבוע?</td>
	<td class="title_sort" align=center>שעת<br>מפגש<BR>קבוצה</td>
	<td class="title_sort" align=center>תאריך<br>מפגש<BR>קבוצה<br><a href="javascript:FuncSort('<%=qrystring%>','sort_8','ASC')"><img src="../../../images/arrow_top<%If Request.Querystring("sort_8")="ASC" then%>_act<%end if%>.gif"  title="למיין לפי תאריך מפגש" border=0></a><a href="javascript:FuncSort('<%=qrystring%>','sort_8','DESC')"><img src="../../../images/arrow_bot<%If Request.Querystring("sort_8")="DESC" then %>_act<%end if%>.gif"  title="למיין לפי תאריך מפגש" border=0></a></td>
	<td class="title_sort" style="padding:3px" align=center>שעת<BR>בריף</td>
	<td class="title_sort" align=center>תאריך<BR>בריף<br><a href="javascript:FuncSort('<%=qrystring%>','sort_7','ASC')"><img src="../../../images/arrow_top<%If Request.Querystring("sort_7")="ASC" then%>_act<%end if%>.gif"  title="למיין לפי תאריך בריף" border=0></a><a href="javascript:FuncSort('<%=qrystring%>','sort_7','DESC')"><img src="../../../images/arrow_bot<%If Request.Querystring("sort_7")="DESC" then %>_act<%end if%>.gif"  title="למיין לפי תאריך בריף" border=0></a></td>
	<td class="title_sort" align=center>תאריך<BR>קבלת<br> Itinerary<br><a href="javascript:FuncSort('<%=qrystring%>','sort_6','ASC')"><img src="../../../images/arrow_top<%If Request.Querystring("sort_6")="ASC" then%>_act<%end if%>.gif"  title="למיין לפי Itinerary" border=0></a><a href="javascript:FuncSort('<%=qrystring%>','sort_6','DESC')"><img src="../../../images/arrow_bot<%If Request.Querystring("sort_6")="DESC" then %>_act<%end if%>.gif"  title="למיין לפי Itinerary" border=0></a></td>
	<td class="title_sort" align=center  style="padding:3px">ספק<br><a href="javascript:FuncSort('<%=qrystring%>','sort_10','ASC')"><img src="../../../images/arrow_top<%If Request.Querystring("sort_10")="ASC" then%>_act<%end if%>.gif"  title="למיין לפי ספק" border=0></a><a href="javascript:FuncSort('<%=qrystring%>','sort_10','DESC')"><img src="../../../images/arrow_bot<%If Request.Querystring("sort_10")="DESC" then %>_act<%end if%>.gif"  title="למיין לפי ספק" border=0></a></td>
	<td class="title_sort" align=center>טלפון<BR>של מדריך</td>
	<td class="title_sort" align=center>שם<br>המדריך<br><a href="javascript:FuncSort('<%=qrystring%>','sort_5','ASC')"><img src="../../../images/arrow_top<%If Request.Querystring("sort_5")="ASC" then%>_act<%end if%>.gif"  title="למיין לפי המדריך" border=0></a><a href="javascript:FuncSort('<%=qrystring%>','sort_5','DESC')"><img src="../../../images/arrow_bot<%If Request.Querystring("sort_5")="DESC" then %>_act<%end if%>.gif"  title="למיין לפי המדריך" border=0></a></td>
	<td class="title_sort"  align="center">?כרגע בחול</td>	
	<td class="title_sort"  align="center">תאריך<BR>חזרה<br><a href="javascript:FuncSort('<%=qrystring%>','sort_4','ASC')"><img src="../../../images/arrow_top<%If Request.Querystring("sort_4")="ASC" then%>_act<%end if%>.gif"  title="למיין לפי תאריך חזרה" border=0></a><a href="javascript:FuncSort('<%=qrystring%>','sort_4','DESC')"><img src="../../../images/arrow_bot<%If Request.Querystring("sort_4")="DESC" then %>_act<%end if%>.gif"  title="למיין לפי תאריך חזרה" border=0></a></td>	
	<td class="title_sort" align="center">&nbsp;תאריך<BR>יציאה<br><a href="javascript:FuncSort('<%=qrystring%>','sort_3','ASC')"><img src="../../../images/arrow_top<%If Request.Querystring("sort_3")="ASC" then%>_act<%end if%>.gif"  title="למיין לפי תאריך יציאה" border=0></a><a href="javascript:FuncSort('<%=qrystring%>','sort_3','DESC')"><img src="../../../images/arrow_bot<%If Request.Querystring("sort_3")="DESC" then %>_act<%end if%>.gif"  title="למיין לפי תאריך יציאה" border=0></a></td>
	<td class="title_sort"  align="center" >קוד<br>טיול</td>
	<td class="title_sort"  align="center" nowrap>תאריך</td>
	<td class="title_sort" align=center>&nbsp;טיול<br><a href="javascript:FuncSort('<%=qrystring%>','sort_2','ASC')"><img src="../../../images/arrow_top<%If Request.Querystring("sort_2")="ASC" then%>_act<%end if%>.gif"  title="למיין לפי קוד סדרה" border=0></a><a href="javascript:FuncSort('<%=qrystring%>','sort_2','DESC')"><img src="../../../images/arrow_bot<%If Request.Querystring("sort_2")="DESC" then %>_act<%end if%>.gif"  title="למיין לפי קוד סדרה" border=0></a></td>
	<td class="title_sort" align=center>&nbsp;אופרטור&nbsp;<br><a href="javascript:FuncSort('<%=qrystring%>','sort_1','ASC')"><img src="../../../images/arrow_top<%If  Request.Querystring("sort_1")="ASC" then%>_act<%end if%>.gif"  title="למיין לפי אופרטור" border=0></a><a href="javascript:FuncSort('<%=qrystring%>','sort_1','DESC')"><img src="../../../images/arrow_bot<%If  Request.Querystring("sort_1")="DESC" then %>_act<%end if%>.gif"  title="למיין לפי אופרטור" border=0></a></td>
	<td></td>
</tr>
