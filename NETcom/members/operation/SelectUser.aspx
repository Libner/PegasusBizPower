<%@ Page Language="vb" AutoEventWireup="false" Codebehind="SelectUser.aspx.vb" Inherits="bizpower_pegasus.SelectUser" %>
<!DOCTYPE html>
<html>
	<head>
		<title><%=fTitle%></title>
...
<tr>
				...
				<tr>
					<td align="center">
						<select id="fselect" name="fselect"  dir=rtl runat=server multiple size=10 style="width:120px;font-size:9pt;font-family:arial;">
