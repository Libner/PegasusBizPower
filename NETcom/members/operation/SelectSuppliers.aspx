<%@ Page Language="vb" AutoEventWireup="false" Codebehind="SelectSuppliers.aspx.vb" Inherits="bizpower_pegasus2018.SelectSuppliers" %>
<!DOCTYPE html>
<HTML>
	<HEAD>
		<title>&lt;SCRIPT LANGUAGE="SERVERASP"&gt;&lt;!--=fTitle--&gt;&lt;/SCRIPT&gt;</title>
	...
	<body style="margin:0px;" onload="self.focus();">
		<form id="Form1" method="post" runat="server">
			<table width="100%" align="center" cellspacing="0" cellpadding="2" border="0">
				...
				<tr>
					<td align="center">
						<select id="fselect" name="fselect" dir="rtl" runat="server" multiple style="width: 300px; font-family: arial; font-size: 9pt;"
							size="25">
						</select>
					</td>
				</tr>
