Public Class SelectVouchers_Provider
...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If Not Page.IsPostBack Then
            ...
            getVouchers_Provider()

        Else

            ss = Request.Form("fselect")
            ssName = ss ' GetSelectUserName()
            Dim cScript As String
            If ss = "0" Then
                cScript = "<script language='javascript'>opener.document.getElementById('Vouchers_ProviderSelect').value = '" & Replace(ss, "'", "&#" & AscW(Chr(39)) & ";") & "'; opener.document.getElementById('SelectVouchers_ProviderAlt').src='../../images/select.png';opener.document.getElementById('SelectVouchers_ProviderAlt').title='" & ssName & "';self.close(); </script>"

            Else
                cScript = "<script language='javascript'>opener.document.getElementById('Vouchers_ProviderSelect').value = '" & Replace(ss, "'", "&#" & AscW(Chr(39)) & ";") & "'; opener.document.getElementById('SelectVouchers_ProviderAlt').src='../../images/select_act.png';opener.document.getElementById('SelectVouchers_ProviderAlt').title='" & ssName & "';self.close(); </script>"
    ...
    Sub getVouchers_Provider()
        ...
        Dim list2 As New ListItem("כן", "כן")
        fselect.Items.Insert(1, list2)
        Dim list3 As New ListItem("לא", "לא")
        fselect.Items.Insert(2, list3)
        Dim list4 As New ListItem("מותאם", "מותאם")
        fselect.Items.Insert(3, list4)
        'End If
