<%@ Page Language="vb" AutoEventWireup="false" Codebehind="WorkScreen.aspx.vb" Inherits="bizpower_pegasus2018.WorkScreen" %>
...
f.sisExcellenceH.value=document.getElementById("sisExcellence").value;
...
f.sGuideStatusH.value=document.getElementById("sGuideStatus").value
...
function SendShortData(tab,query)
{
		...
		document.getElementById("sisExcellence").value=''
		...
		document.getElementById("sGuideStatus").value='';	
...
<form id="Form1" method="post" runat="server" name="Form1">
	...
	<DS:TOPIN id="topin" numOfLink="0"  numOfTab="82" toplevel2="85" runat="server"></DS:TOPIN>
				...
				<table border="0" cellpadding="2" cellspacing="0" align="center" width=100%>
						<tr>
						<td><a href="javascript:void(0)" onclick="return openReportExcel();" class="button_edit_1" style="width:220;" nowrap>דוח רשימת חשבוניות שטרם בוצעה עבורם התאמה</a></td>
						<td width="10"></td>
							...
							<td width="10"></td>
							<td><a href="#" onclick="javascript:SendShortData('10','')" class="button_edit_1" style="width:115;">רשימת בריפים קדימה</a></td>
							<td width="10"></td>
							<td><a href="#" onclick="javascript:SendShortData('5','')" class="button_edit_1" style="width:135;">הטיולים שיצאו אין תמחור</a></td>
							<td width="10"></td>
							<td><a href="#" onclick="javascript:SendShortData('4','')" class="button_edit_1" style="width:115;" nowrap>לא תואם בריף החזרה</a></td>
							<td width="10"></td>
							<%if false then%>
							...
							<td width="10"></td>
							<%end if%>
							<td><a href="#" onclick="javascript:SendShortData('9','')" class="button_edit_1" style="width:105;">לא תואם בריף</a></td>
							<td width="10"></td>
					...
					<td valign="top" align="left">
						<table cellpadding="1" cellspacing="1" width="100%" align="left" style="border:solid 1px #d3d3d3">
							...
							<td>&nbsp;</td>
								...
								<Td>&nbsp;<!--tel--></Td>
								<Td class="title_sort"  align=center nowrap valign="bottom"><!--guideStatus-->
								<select id="sGuideStatus" name="sGuideStatus" dir="rtl" class="searchList" runat="server">
									<option value="">בחר</option>
									</select></Td>
							<Td class="title_sort"  align=center nowrap valign="bottom"><select id="sisExcellence" name="sisExcellence" dir="rtl" class="searchList">
							     		<option value="">בחר</option>
										<option value="כן" <%if pisExcellence="1" then%>selected<%end if%>>כן</option>
										<option value="לא" <%if pisExcellence="0" then%>selected<%end if%>>לא</option>
									</select></td>
								...
								<Td class="title_sort" valign="bottom"  nowrap align=center ><a href="" onclick="cal1xx.select(document.getElementById('sFromDateEnd'),'AsFromDateEnd','dd/MM/yy'); return false;"
										id="AsFromDateEnd"><img src="../../images/calendar.gif" width=20 border="0" align="center"></a><input runat="server" type="text" id="sFromDateEnd" class="searchList" style="WIDTH:45px"
									...
									<a href="" onclick="cal1xx.select(document.getElementById('sToDateEnd'),'AsToDateEnd','dd/MM/yy'); return false;"
										id="AsToDateEnd"><img src="../../images/calendar.gif" width=20 border="0" align="center"></a><input runat="server" type="text" id="sToDateEnd" class="searchList" style="WIDTH:45px"
								...
								<Td class="title_sort" style="width:89px" valign="bottom" nowrap><a href="" onclick="cal1xx.select(document.getElementById('sFromDate'),'AsFromDate','dd/MM/yy'); return false;"
										id="AsFromDate"><img src="../../images/calendar.gif" width=20 border="0" align="center"></a><input runat="server" type="text" id="sFromDate" class="searchList" style="WIDTH:45px"
										NAME="sFromDate" readonly><br>
									<a href="" onclick="cal1xx.select(document.getElementById('sToDate'),'AsToDate','dd/MM/yy'); return false;"
										id="AsToDate"><img src="../../images/calendar.gif" width=20 border="0" align="center"></a><input runat="server" type="text" id="sToDate" class="searchList" style="WIDTH:45px" readonly
										NAME="sToDate"></Td>
								<td class="title_sort">&nbsp;<!--הרשומים העכשווית-->&nbsp;</td>
							...
							<td align=center>Rooming<BR>List</td>
								...
								<td class="title_sort" align="center">טלפון<BR>
									של מדריך</td>
									<td class="title_sort" align="center"><!--guideStatus-->סטטוס<br>
									המדריך<br>
									<a href="javascript:FuncSort('<%=qrystring%>','sort_11','ASC')"><img src="../../../images/arrow_top<%If Request.Querystring("sort_11")="ASC" then%>_act<%end if%>.gif"  title="למיין לפי סטטוס מדריך" border=0></a><a href="javascript:FuncSort('<%=qrystring%>','sort_11','DESC')"><img src="../../../images/arrow_bot<%If Request.Querystring("sort_11")="DESC" then %>_act<%end if%>.gif"  title="למיין לפי סטטוס מדריך" border=0></a></td>
								<td class="title_sort" align="center">זכאי<br> לגמול <br>מצוינות</td>
								...
								<td class="title_sort" align="center">הרשומים<br> העכשווית</td>
							...
							<asp:Repeater ID="rptData" Runat="server">
								...
								<td align=center><a href="#" onclick="window.open('RoomingList.aspx?dID=<%#Container.DataItem("Departure_Id")%>','winCA','top=20, left=10, width=1000, height=350, scrollbars=1');"><img src="../../images/poit.png" border="0" alt="Rooming List" width=15></a></td>
										...
										<td align="center" style="background-color:<%#Container.DataItem("GuideStatusBGColor")%>;color:<%#Container.DataItem("GuideStatusFntColor")%>"><%#Container.DataItem("GuideStatusName")%></td>								
										<td  align="center"><a href="#" onclick="window.open('https://pegasusisrael.co.il/assign/?guide=<%#Container.DataItem("Guide_Id")%>&crmadm=1','winCA','top=20, left=10, width=1000, height=350, scrollbars=1');"><%#Container.dataItem("GuideIsExcellence")%></a></td>	
										<td align="center" style="background-color:<%#Container.DataItem("GuideStatusBGColor")%>;color:<%#Container.DataItem("GuideStatusFntColor")%>"><%'#iif(container.DataItem("GuideName") is DBNULL.value,"",container.DataItem("GuideName") )%><%#Container.DataItem("GuideName")%></td>
										...
										<td align="center" nowrap><%#Container.dataItem("CountMembers")%></td>
								...
								<AlternatingItemTemplate>
									...
									<td align=center><a href="#" onclick="window.open('RoomingList.aspx?dID=<%#Container.DataItem("Departure_Id")%>','winCA','top=20, left=10, width=1000, height=350, scrollbars=1');""><img src="../../images/poit.png" border="0" alt="Rooming List" width=15></a></td>
										...
										<td align="center" style="background-color:<%#Container.DataItem("GuideStatusBGColor")%>;color:<%#Container.DataItem("GuideStatusFntColor")%>"><%#Container.DataItem("GuideStatusName")%></td>		
										<td align="center"><a href="#" onclick="window.open('https://www.pegasusisrael.co.il/assign/?guide=<%#Container.DataItem("Guide_Id")%>&crmadm=1','winCA','top=20, left=10, width=1000, height=350, scrollbars=1');"><%#Container.dataItem("GuideIsExcellence")%></a></td>							
										<td align="center" style="background-color:<%#Container.DataItem("GuideStatusBGColor")%>;color:<%#Container.DataItem("GuideStatusFntColor")%>"><%'#iif(container.DataItem("GuideName") is DBNULL.value,"",container.DataItem("GuideName") )%><%#Container.DataItem("GuideName")%></td>
										<td align="center"><%#func.TourStatusForOperation(Container.DataItem("Departure_Id"),func.dbNullFix(Container.DataItem("Departure_Date")),func.dbNullFix(Container.DataItem("Departure_Date_End")))%></td>
										<td align="center" nowrap><%#DataBinder.Eval(Container.DataItem, "Departure_Date_End", "{0:dd/MM/yy}")%></td>
										<td align="center" nowrap><%#DataBinder.Eval(Container.DataItem, "Departure_Date", "{0:dd/MM/yy}")%></td>
	...
	//cal1xx.setYearSelectStart(1910); //Added by Mila
			...
			<form id="Form2" method="post"  name="Form2" target="_blank">
				...
				<input type=hidden id="sisExcellenceH" name="sisExcellenceH">
			    ...
			    <input type=hidden id="sGuideStatusH" name="sGuideStatusH">
		</form>
	</body>
</html>
