<%@ Page Language="vb" AutoEventWireup="false" Codebehind="SelectVouchers_Provider.aspx.vb" Inherits="bizpower_pegasus.SelectVouchers_Provider" %>
	...
	<body style="MARGIN:0px" onload="self.focus();">
		<form id="Form1" method="post" runat="server">
			<table width="100%" align="center" cellspacing="0" cellpadding="2" border="0">
				<tr>
					<td bgcolor="#e6e6e6" height="5" align="center" width="100%"><b>?כרגע בחול<br></b></td>
				</tr>
<tr>
