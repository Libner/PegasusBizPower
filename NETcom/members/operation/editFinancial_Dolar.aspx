<%@ Page Language="vb" AutoEventWireup="false" Codebehind="editFinancial_Dolar.aspx.vb" Inherits="bizpower_pegasus.editFinancial_Dolar" %>
...
<body style="margin:0px" onload="self.focus();">
		<form id="Form1" method="post" runat="server">
			<table width="100%" align="center" cellspacing="0" cellpadding="2" border="0">
				...
				<tr>
					<td align="center" >
						<input dir="ltr" name="Financial_Dolar" id="Financial_Dolar" style="WIDTH:60px;HEIGHT:30px" value="<%=Financial_Dolar%>">
					</td>
				</tr>
				<tr>
