...
<tr><td width="100%" class="page_title" dir=rtl>&nbsp;Excel&nbsp;טעינת נמענים מקובץ&nbsp;</td></tr>         
...
<table cellpadding=0 cellspacing=0 width=100%>
<tr>
<td width=100% align=right><INPUT type=button class="but_menu" onclick="window.open('../../../download/listsms.xls')" value="הורד" style="width:70"></td>
