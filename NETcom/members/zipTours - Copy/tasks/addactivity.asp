...
<%
  ...
  If Request.QueryString("add") <> nil Then	
    ...
    If trim(Request.Form("taskId")="") And (add_task = true) And trim(Request.Form("activityId")="") Then ' להוסיף משימה חדשה	    
	...
	ElseIf trim(Request.Form("taskId")<>"") Then ' עדכון משימה
...
<tr>
  <td align=right width=50% nowrap bgcolor="#e6e6e6" valign="top" style="border: 1px solid #808080;border-top:none">
   ...
   <td align=right width=65 nowrap>תאריך יעד</td>   
   </tr>
   <tr><td align=right width=100%>
    ...
    <td align=right width=65 nowrap>... אל</td>
    </tr>    
    </table></td></tr>              
   <%
...
<td align=right width=50% nowrap bgcolor="#e6e6e6" valign="top" style="border: 1px solid #808080;border-left:none;border-top:none">
   ...
   <tr><td colspan=2>
       ...
       <tr>
		...
		<td align=right width=65 nowrap>תאריך</td>   
	   </tr>	  
	 <tr><td align=right width=100%>
