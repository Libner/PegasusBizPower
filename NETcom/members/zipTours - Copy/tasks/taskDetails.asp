...
<table border=0 cellpadding=1 cellspacing=1 width=100%>
    ...
    <tr style="line-height:18px"> 	  
          ...
          <td align="center" class="title_sort" width=29 nowrap>&nbsp;</td>   
  	      ...
  	      <td width="100%"  align="<%=align_var%>" dir="<%=dir_obj_var%>" class="title_sort">&nbsp;תוכן משימה&nbsp;</td>	          
...
%>
    <tr>
       <td align="center" class="card<%=class_%>" valign="top">
	      ...
	      <td class="card<%=class_%>" valign="top" align="<%=align_var%>" dir="<%=dir_obj_var%>" >&nbsp;<%=breaks(trim(task_replay))%>&nbsp;</td>	      	      	      
	      <td class="card<%=class_%>" valign="top" align="<%=align_var%>" dir="<%=dir_obj_var%>" >&nbsp;<%=breaks(trim(task_content))%>&nbsp;</td>	      	      	      
          ...
          <td class="card<%=class_%>" valign="top" align="<%=align_var%>" dir="<%=dir_obj_var%>" nowrap><a class="link_categ" <%=href%>>&nbsp;<%=contactName%>&nbsp;</a></td>
          ...
          <%End If%>
          <td class="card<%=class_%>" valign="top" align="<%=align_var%>" dir="<%=dir_obj_var%>" nowrap><a class="link_categ" <%=href%>>&nbsp;<%=reciver_name%>&nbsp;</a></td>
          <td class="card<%=class_%>" valign="top" align="<%=align_var%>" dir="<%=dir_obj_var%>" nowrap><a class="link_categ" <%=href%>>&nbsp;<%=sender_name%>&nbsp;</a></td>
          <td class="card<%=class_%>" valign="top" align="<%=align_var%>" dir="<%=dir_obj_var%>" nowrap><a class="link_categ" <%=href%> style="font-size: 8pt;" <%if IS_DESTINATION and status <> 3 then%> name=word27 title="<%=arrTitles(27)%>"><span style="width:9px;COLOR: #FFFFFF;BACKGROUND-COLOR: #FF0000;text-align:center"><b>!</b></span><%else%>><%end if%><%If isDate(task_date) Then%>&nbsp;<%=task_date%>&nbsp;<%End If%></a></td>         
