...
function Init() {
  ...
  var editdoc = globalDoc.GetDocument();   
  ...
  if(editdoc.images("tofes") && !ImageTofes)
...
function btnOKClick() {
  ...
  if (editdoc.selection.type == htmlSelectionControl || grngMaster.htmlText) {
	if(!ImageTofes)
	{
    ...
    grngMaster = editdoc.selection.createRange();
  }
...
<BUTTON style="top: 15px;left:160px ;width: 22px; height: 22px; border: 1px none;"  unselectable="on" onclick="setBgrColor();" id=button4 name=button4><img id=imgbgrColor style="background-color:#000000;" src="<%=Application("VirDir")%>/netcom/images/selcolor.gif" border=0></BUTTON>
...
<BUTTON style="top: 15px;left:312px ;width: 22px; height: 22px; border: 1px none;"  unselectable="on" onclick="setTextColor();" id=button3 name=button3><img id=imgtxtColor style="background-color:#000000;" src="<%=Application("VirDir")%>/netcom/images/selcolor.gif" border=0></BUTTON>
