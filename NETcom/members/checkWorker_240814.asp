...
if Request.Form("username")<>nil then
	...
	" isNULL(UseBizLogo, 0) as UseBizLogo,isNULL(Add_Insurance, 0) as Add_Insurance,isNULL( Add_GroupsTours, 0) as  Add_GroupsTours, JOB_ID FROM USERS INNER JOIN ORGANIZATIONS ON " &_
