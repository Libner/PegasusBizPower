...
#End Region
    ...
    Private Sub rptMonth_ItemDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.RepeaterItemEventArgs) Handles rptMonth.ItemDataBound
        If e.Item.ItemType = ListItemType.Item Or e.Item.ItemType = ListItemType.AlternatingItem Then
            ...
            Else
                con.Close()
                Dim cmdSelectBlank = New SqlCommand("SELECT top 1 @month as Dim_Month,0 as Sales,0 as SalesYear,0 as Sales_Point,0 as KishuritService_Point,0 as ActiveTime_Point,0 as ActiveTime,0 as ActiveTimeBefore from Departments_Data_Monthly" & _
                              " ", con)
                '   cmdSelect.Parameters.Add("@currYear", SqlDbType.Int).Value = CInt(currYear)
