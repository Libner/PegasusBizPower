...
<script>
 $(document).ready(function () {
	/*widthTour=  $( "#input_selTour" ).width()
	widthCompetitor=  $( "#input_selCompetitor" ).width()
	maxInputWidth=Math.max(widthTour,widthCompetitor)*/
	tblSearchWidth= $( "#tblSearch" ).width()
	widthButtonAll=parseFloat($( ".ui-button" ).css('width'))
	tableWidth=(tblSearchWidth+widthButtonAll)
	$("#blockSearchResults").find('table').first().css('min-width',tblSearchWidth)
	
	$("#blockSearchResults").height($(window).height()-300)
 })
...
function  getScreen(tourId,competitorId)
 {
	...
	$.ajax({
		type: "POST",
		url:"getScreenToViewBySearchTerms_popup.asp",
...
function fillCompetitorsSelByTour(tourId,competitorId)
{
	...
	<body class="body_admin">
		<table border="0" width="100%" cellspacing="0" cellpadding="0" ID="Table4">
			<tr>
                    <td class="td_admin_3" colspan="2" dir="ltr">
                        <table border="0" align="center" width="100%" cellspacing="0" cellpadding="0" class="table_admin_2" ID="Table2">
                            <tr>
                                <td nowrap="nowrap" class="td_title_2"><a class="button_admin_1" href="" onclick="window.close();return false"  title"סגור חלון"><i class="fa fa-arrow-left"></i></a></td>
                                <td class="td_admin_3" colspan="2" dir="rtl" width="100%">מסכי השוואה</td>
                             </tr>
						...
						<tr>
							<td width="100%">
								<table border="0"  cellspacing="0" cellpadding="0" align="center" ID="Table1">
									<tr>
										<td  align=center>
											<table  cellspacing="1" cellpadding="2" align="center" border="0" ID="tblSearch"
												dir="ltr">
												<!--site Competitor-->
												<%	
										...
										%>
												<tr>
													<TD align="<%=align_var%>" dir="<%=dir_obj_var%>" width="100%">
														<div class="ui-widget" style="width:auto;overflow:visible">
													...
													<TD align="<%=align_var%>" dir="<%=dir_obj_var%>" width="100%"><b>שם 
															טיול&nbsp;</b></td>
												</tr>
												<tr>
													<TD align="<%=align_var%>" dir="<%=dir_obj_var%>" width="100%">
													...
													<td align="<%=align_var%>" nowrap dir="<%=dir_obj_var%>"><b>שם 
															מתחרה&nbsp;</b></td>
												</tr>
												<tr>
													<td height="15" nowrap></td>
									...
									<tr>
										<td width="100%" align="center">
											...
											<div id="blockSearchResults" style="overflow-y:scroll">
										
											<table  cellspacing="1" cellpadding="2" align="center" border="0" ID="Table3">
												<tr>
														<td  dir="<%=dir_obj_var%>" class="form_header"><h3><div id="tourTitle"><%=Tour_Name%></div></h3></td>
													</tr>
												<tr>
													<td align="right" nowrap bgcolor="#ffffff" valign="top"  width="100%">
															...
															<tr  style="background-color:#f5f5f5" onmouseover="this.style.backgroundColor ='#e5e5e5'" onmouseout= "this.style.backgroundColor='#f5f5f5'">
																<td valign="top">
																	<table width="100%" cellpadding="0" cellspacing="0">
																		<tr>
																			<td width="50" nowrap align="right" dir="rtl" <%if Parameter_Advantages<>"" and isAdvantages then%> style="color:green"<%else%> style="color:red"<%end if%>>
																				<%=Parameter_Icon%>
																			</td>
																...
																<td valign="top" align="<%=align_var%>"  dir="<%=dir_obj_var%>"   <%if Parameter_Advantages<>"" and isAdvantages then%> style="background-color:#f1ffef"<%else%> style="background-color:#fff0e2"<%end if%>>
																	<%=Parameter_Value_Tour%>
																</td>
																<td valign="top" align="<%=align_var%>"  dir="<%=dir_obj_var%>"  style="background-color:#fffff1">
																	<%=Parameter_Value_Screen%>
																</td>
																<td valign="top" align="center"  <%if Parameter_Advantages<>"" and isAdvantages then%> style="background-color:#e5ffe2"<%else%> style="background-color:#fff0e2"<%end if%>>
																	<%if Parameter_Advantages<>"" and isAdvantages then%>
																	<i class="fa fa-thumbs-up fa-flip-horizontal" aria-hidden="true" style="color:green"></i>
																	<%end if%>
																	<%if Parameter_Advantages<>"" and not isAdvantages then%>
																	<i class="fa fa-thumbs-down fa-flip-horizontal" aria-hidden="true" style="color:red"></i>
																	<%end if%>
																</td>
																<td valign="top" align="<%=align_var%>"  dir="<%=dir_obj_var%>" style="max-width:400px;white-space:normal">
