		...
		<table border="0" width="100%" cellspacing="0" cellpadding="0" dir="<%=dir_var%>" ID="Table1">
			...
			<tr>
				<td align="center" valign="top">
					<table border="0" cellpadding="0" cellspacing="0" width="100%" ID="Table8">
						...
						<tr>
							<td width="100%">
								<table border="0" width="100%" cellspacing="0" cellpadding="0" align="center" ID="Table2">
									<tr>
										<td width="100%">
											<table width="780" cellspacing="0" cellpadding="5" align="center" border="0" ID="Table4"
			...
			<tr>
				<td width="100%" valign="top" align="center">
					<div id="blockSearchResults" style="overflow:scroll">
						<table  cellspacing="1" cellpadding="2" border="0" bgcolor="#ffffff" ID="Table3">
							...
							<tr>
								<td align="<%=align_var%>"  class="itemList">
									<a href="viewScreen.asp?ScreenId=<%=Screen_Id%>"  class="itemList">
										<b>
											<%=Competitor_Name%>
										</b></a></td>
							</tr>
