...
.ui-widget.ui-widget-content {
 ...
 function getScreensList(tourId,competitorId)
 {
	...
	$.ajax({
		type: "POST",
		url:"getScreensToViewBySearchTerms.asp",
						...
						<tr>
							...
							<td bgcolor=DarkGray>
								<table cellspacing="0" cellpadding="0" align="center" border="0" ID="Table7">
									<tr>
									<td colspan=2 align=center class="title_form" style="background-color:DarkGray">חיפוש מסכי השוואה</td>
									</td>
									</tr>
									<tr>
										<td bgcolor="#ffffff">
											<table cellspacing="1" cellpadding="2" align="center" border="0" bordercolor="#ffffff" ID="Table5">
												<!--site Competitor-->
												<%	
									...
									do while not rs_Tours.eof
										...
										%>
													<tr>
														...
														<th  align="<%=align_var%>" bgcolor="#e6e6e6">
															<b>
																<%=Category_Name%>
																-
										...
										%>
													<tr>
														<td align="<%=align_var%>" bgcolor="#e6e6e6" width="100%">
														<a href="viewScreen.asp?ScreenId=<%=Screen_Id%>" target="_blank" class="admin" style="display:block;width:100%;height:100%"><b><%=Competitor_Name%></b>&nbsp;
														<IMG SRC="../../images/preview_icon.gif" BORDER="0" align=absmiddle></a></td>
												</tr>
													<%rs_Comp.MoveNext
										loop
										rs_Comp.close
