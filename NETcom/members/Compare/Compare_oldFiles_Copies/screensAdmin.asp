...
function addScreenBySearch()
{
	...
	document.location.href="addScreen.asp?TourId=" + tourId + "&CompetitorId=" + competitorId
}
					</script>
						...
						<tr>
							<td>
								<table cellspacing="0" cellpadding="0" align="center" border="0" ID="Table6">
									...
									do while not rs_Tours.eof
													...
													<tr>
														...
														<th colspan="3" align="<%=align_var%>" bgcolor="#e6e6e6">
															<b>
																<%=Category_Name%>
																-
																<font color="navy"><%=Tour_Name%></font>
															</b>&nbsp;</th>
													</tr>
													<%
											sqlstr= "Select Screen_Id,Competitor_Name,Start_Date,End_Date  from Compare_Screens "
											sqlstr=sqlstr & "  inner join Compare_Competitors on Compare_Competitors.Competitor_Id=Compare_Screens.Competitor_Id where Tour_Id=" & Tour_Id & " order by Competitor_Name,End_Date desc, Start_Date desc"
										...
										%>
										<tr>
											<td align="center" bgcolor="#e6e6e6" nowrap><a href="screens.asp?deleteId=<%=Screen_Id%>" ONCLICK="return checkDelete(<%=countComp %>)"><IMG SRC="../../images/delete_icon.gif" BORDER="0"></a></td>
											<td align="center" bgcolor="#e6e6e6" nowrap><a href="addScreen.asp?TourID=<%=Tour_Id%>&screenID=<%=Screen_Id%>"><IMG SRC="../../images/edit_icon.gif" BORDER=0 alt="<%=alt_edit%>"></a></td>
							...
							<td width=110 nowrap align="<%=align_var%>" valign=top class="td_menu">
								<table cellpadding="1" cellspacing="1" width="100%" ID="Table4">
									...
									<tr>
										<td nowrap align="center"><a class="button_edit_1" style="width:100;" href="addScreen.asp"><span id="word6" name="word6"><!--הוספת מתחרה-->הוספת מסך השוואה</span></a></td>
									</tr>
								</table>
							</td>
						</tr>
