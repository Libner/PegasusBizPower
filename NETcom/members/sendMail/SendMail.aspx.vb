...
Public Class SendMail1
    ...
    Protected defUserId, defDepId, trappEmail As String
...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If Request("trappEmail") <> "" Then
            trappEmail = Request("trappEmail")
        End If
        '   Response.Write("trappEmail=" & Request("trappEmail"))
    ...
    Public Sub SendMail()
        ...
        content = "<div style='direction:rtl'>" & Request.Form("sContent") & "</div>"
        ...
        Try
            ...
            objMail.Bcc = BCCMail
            objMail.To = ToMail
            objMail.To = "itamar.nir@pegasusisrael.co.il" '"faina@cyberserve.co.il" ' 

            objMail.Subject = pSubject
            objMail.Body = content ' func.breaks(content)
    ...
    Public Sub GetUsers()
        ...
        squery = "select  User_Id,Email,(FIRSTNAME + Char(32) + LASTNAME) as [USER_NAME] from Users where  len(email)>0 and ACTIVE=1 and User_Id in (" & trappEmail & ") order by USER_NAME"
        ' and Department_Id=" & DepId & "
        '   Response.Write(squery)
