...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Else
            ...
            If ss = 0 Then
                cScript = "<script language='javascript'>opener.document.getElementById('UsersSelect').value = '" & Replace(ss, "'", "&#" & AscW(Chr(39)) & ";") & "'; opener.document.getElementById('SelectUserAlt').src='../../images/select.png';opener.document.getElementById('SelectUserAlt').title='" & ssName & "';opener.document.Form1.submit();self.close(); </script>"

            Else
                cScript = "<script language='javascript'>opener.document.getElementById('UsersSelect').value = '" & Replace(ss, "'", "&#" & AscW(Chr(39)) & ";") & "'; opener.document.getElementById('SelectUserAlt').src='../../images/select_act.png';opener.document.getElementById('SelectUserAlt').title='" & ssName & "';opener.document.Form1.submit();self.close(); </script>"
    ...
    End Function
    Sub getUsers()
        Dim cmdSelect As New SqlClient.SqlCommand("SELECT USER_ID, FIRSTNAME + ' ' + LASTNAME as Username from Users  where [ACTIVE]=1  order by FIRSTNAME asc ,LASTNAME asc", conB)
        cmdSelect.CommandType = CommandType.Text
        conB.Open()
