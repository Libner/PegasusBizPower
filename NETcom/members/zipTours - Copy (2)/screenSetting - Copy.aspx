...
<tr bgcolor=#BCBBD5 style="height:25px" >
...
<%IF ViewColumn(11)=true then%><td><select runat="server" id="sUsers" class="searchList" dir="rtl" name="sUsers"></select></td><%end if%>
<td ></td>
<td ></td>
<td ></td>
<td ></td>
...
<%IF ViewColumn(5)=true then%><td align=right><select runat="server" id="sDepartments" class="searchList" dir="rtl" name="sDepartments"></select></td><%end if%>
	<td class="td_admin_5" align="right" nowrap><a href="" onclick="cal1xx.select(document.Form1.sPayToDate,'AsPayToDate','dd/MM/yyyy'); return false;"
										...
										<input runat="server" type="text" id="sPayToDate" class="searchList" style="WIDTH:70px"
											NAME="sPayToDate"> עד &nbsp;&nbsp; </td>
									<td class="td_admin_5" align="right" nowrap><a href="" onclick="cal1xx.select(document.Form1.sPayFromDate,'AsPayFromDate','dd/MM/yyyy'); return false;"
										...
										<input runat="server" type="text" id="sPayFromDate" class="searchList" style="WIDTH:70px"
											NAME="sPayFromDate"> מי תאריך &nbsp;&nbsp;</td>

<%IF ViewColumn(2)=true then%><td><select runat="server" id="sSeries" class="searchList" dir="rtl" name="sSeries" ></select></td><%end if%>

<%IF ViewColumn(1)=true then%><td align=right><select runat="server" id="sStatus" class="searchList" dir="rtl" name="sStatus"></select></td><%end if%>
<td></td>
</tr>
...
<td align=center><%#Container.DataItem("CountMembers")%></td>
...
<td align=center align=center style="padding-top:1px;padding-bottom:1px">
<table border=0 style="background-color:<%#Container.DataItem("Status_Color")%>;width:120px" cellpadding=1 cellspacing=1 align=right>
<tr><td align=right><span style="color:#ffffff">&nbsp;<%#Container.DataItem("Status_Name")%>&nbsp;</span></td>
...
<%end if%>
  ...
  <td width=100 nowrap valign=top class="td_menu" style="border: 1px solid #808080" dir="rtl">
	...
	<tr><td colspan="2" height=10 nowrap><a class="button_edit_1" style="width:94;" href="javascript:void(0)" onclick="">עדכן מסך צפייה</td></tr>
