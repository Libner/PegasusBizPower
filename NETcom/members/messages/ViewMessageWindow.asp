...
function timeout_trigger() {
    ...
    document.getElementById("button_read").className ="but_menu_Yellow"
}
...
<%if false then%>	<tr>
	...
	<tr>             
		<td align="<%=align_var%>"  valign=top dir="<%=dir_obj_var%>"><span  class="Form_R" style="width:340;height:50;overflow : auto;"><%=breaks(message_replay)%></span></td>
...
<td align=center width=140 nowrap>
<input type=button id=button_read name=button_read  disabled="disabled"  value="קראתי" class="but_menu_Yellow_dis" onclick="javascript:updateStatus('<%=MessageId%>','2')">
</td>
</tr></table></td>	
	</table></td></tr>
	<%end if%>
