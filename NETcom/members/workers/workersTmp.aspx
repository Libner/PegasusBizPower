...
<table id="example" class="stripe row-border cell-border order-column" cellspacing="0" width="100%">
        <thead>
            <tr>
                ...
                <asp:Repeater id=rptMVCTitle runat=server>
                 <ItemTemplate>
                   <th nowrap valign=middle><b><%#Container.dataItem("SubSitesName")%></b><br><%#Container.DataItem("ScreenName")%><br><%#Container.DataItem("ActionName")%></th>
            </ItemTemplate>
                </asp:Repeater>
 	...
 	<asp:Repeater id="rptWorkers" runat="server" >
          ...
          <ItemTemplate> 
           ...
           <asp:Repeater id=rptMVCData runat=server>
                 <ItemTemplate>
                   <td><%#IIf (trim(func.DbNullFix(Container.DataItem("Is_Permision"))) = "1" ,"V","")%><%'#Container.DataItem("Is_Permision")%><%'#Container.DataItem("ActionName")%></td>
            </ItemTemplate>
                </asp:Repeater>
