...
<table border="0" width="100%" bgcolor="#FFFFFF" cellspacing="0" cellpadding="0">
   <tr>    
	...
	<td width="15%" align="<%=align_var%>" class="title_sort"><!--שם עובד--><%=arrTitles(9)%></td>
	<%if arch=0 then%>
...
sqlStr = "EXEC dbo.users_site_list " & OrgId & "," &arch & ",'" & sqlQuery &"'"
''Response.Write sqlStr
'response.end
 j=0
...
<tr><td colspan=2>
    ...
    <OPTION value="0" <%if trim(app_DepId)="0" or trim(app_DepId)="" then%>selected  <%end if%>>כל המחלקות</OPTION>
