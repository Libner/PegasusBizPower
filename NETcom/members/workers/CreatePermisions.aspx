	...
	<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			<table border="0" cellpadding="0" cellspacing="0" align="center" width="100%">
				<tr>
					<td height="30" align="center" dir="rtl"><span style="COLOR: #6F6DA6;font-size:14pt">ניהול 
							הרשאה למתן הרשאות לעובד
							<br>
							<b>
								<%=UserName%>
							</b></span>
			...
			<table border="0" cellpadding="0" cellspacing="0" align="right" ID="Table13" style="background-color:#ffffff;display:block"
										...
										<tr>
											<td width="100%" colspan="2" align="right">
												<table cellspacing="1" cellpadding="1" width="100%">
													<tr>
														<td width="100%" align="center" class="title_sort" colspan="2" height="25">מטיילים</td>
													</tr>
													...
													<asp:PlaceHolder ID="ph90097FieldActions" Runat="server" visible=false>
													<tr>
											<td width="100%" colspan="2" align="right" bgcolor="#ffffff">
												<table cellspacing="1" cellpadding="1" width="100%" dir="rtl">
												<tr>
														<td width="100%" align="center" class="title_sort"colspan="2" height="25">הרשאות לשדות בישות מטיילים</td>
													</tr>
													<asp:Repeater ID="rpt90097Fields" Runat="server">
														<ItemTemplate>
															<tr>
																<td align="right" class="title_show_form" bgcolor="#e6e6e6"  width="125" nowrap dir="rtl" valign="top"><%#Container.DataItem("Field_Name")%>&nbsp;&nbsp;</td>
																<td width="100%"  bgcolor="#e6e6e6" align="right">
												<table cellspacing="1" cellpadding="1" >
											<tr>
												<asp:Repeater ID="rpt90097FieldActions" Runat="server">
														<ItemTemplate>
																<td align="right" nowrap><input type="checkbox" dir="ltr" name="is_visibleAction<%#Container.DataItem("Action_Id")%>"  ID="is_visibleAction<%#Container.DataItem("Action_Id")%>" <%#IIF(Container.DataItem("is_visible")=1,"checked","")%>></td>
															<td align="right" class="title_show_form" nowrap dir="rtl" valign="top"><%#Container.DataItem("Action_Name")%>&nbsp;&nbsp;</td>
															</ItemTemplate>
														</asp:Repeater>
											</tr>
											</table>
				...
				<tr>
					<td class="title" align="right" dir="rtl"><!--הרשאות--> הרשאות כניסה 
						למודולים&nbsp;&nbsp;<span style="font-weight:500">(סמן בקוביה הימנית את המודול בו 
							העובד רשאי לטפל ובהמשך לאיזה חלקים מתוכו יקבל הרשאה) </span>
					</td>
				</tr>
				<tr>
					<td valign="top" bgcolor="#e6e6e6">
