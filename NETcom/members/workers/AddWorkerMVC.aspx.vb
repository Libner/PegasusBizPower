...
Public Class AddWorkerMVC
    ...
    Protected UserId, workerId As Integer
...
#End Region
    ...
    Private Sub rptSubSites_ItemDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.DataListItemEventArgs) Handles rptSubSites.ItemDataBound
        If e.Item.ItemType = ListItemType.Item Or e.Item.ItemType = ListItemType.AlternatingItem Then
            ...
            Dim cmdSelect = New SqlCommand("Select ScreenId,ScreenName, dbo.IsVisibleMVCScreen(ScreenId," & UserId & ") as is_visible,  dbo.IsVisibleMVCScreenPermission(ScreenId," & workerId & ") as is_visiblePerm  FROM SubSitesScreens where SubSitesId=@SubSitesId order by ScreenOrder", conAction)
    ...
    Public Sub CreaterptScreenAction(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.RepeaterItemEventArgs)
        ...
        If e.Item.ItemType = ListItemType.Item Or e.Item.ItemType = ListItemType.AlternatingItem Then
            ...
            Dim cmdSelect = New SqlCommand("SELECT ActionName,*,dbo.IsVisibleMVCScreenAction(ActionId," & UserId & ") as is_visible,dbo.IsVisibleMVCScreenActionPermission(ActionId," & workerId & ") as is_visiblePerm  FROM  SubSitesScreenAction WHERE(ScreenId = @ScreenId) ORDER BY ActionOrder", conAction1)
