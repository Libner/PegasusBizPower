...
<table border="0" width="100%" bgcolor="#FFFFFF" cellspacing="0" cellpadding="0">
   <tr>    
	...
	<td width="15%" align="<%=align_var%>" class="title_sort">שווי כספי של הזמנה</td>
	<td width="15%" align="<%=align_var%>" class="title_sort">יעד הזמנות מינימלי</td>
...
<%elseif trim(sort)="4" then%><a class="title_sort" href="<%=urlSort%>&amp;sort=<%=sort-1%>"  title=""><%else%><a class="title_sort" href="<%=urlSort%>&amp;sort=3"  title=""><%end if%>
	...
	<td width="15%" align="<%=align_var%>" class="title_sort<%if trim(sort)="1" OR trim(sort)="2" then%>_act<%end if%>">
