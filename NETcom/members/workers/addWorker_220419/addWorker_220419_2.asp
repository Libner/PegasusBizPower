...
<%	rs_jobs.moveNext
	...
	<td align=left class="title_show_form" nowrap >&nbsp;<!--עיסוק--><%=arrTitles(7)%>&nbsp;<span style="color:#FF0000">*</span></td>
	<td align="<%=align_var%>" nowrap>
...
<%	rs_dep.moveNext
	...
	<td align="left" class="title_show_form" nowrap>&nbsp;שיוך למחלקה&nbsp;</td>
	...
	<td align="left"  class="title_show_form" nowrap>&nbsp;יעד הזמנות מינימלי&nbsp;</td>
	...
	<td align="left"  class="title_show_form" nowrap dir=rtl>&nbsp;שווי כספי של הזמנה&nbsp;&nbsp;</td>
</tr>
...
<tr>
	...
	<td align=left class="title_show_form" nowrap>&nbsp;<!--שם פרטי--><%=arrTitles(3)%>&nbsp;<span style="color:#FF0000">*</span></td>
	...
	<td align=left class="title_show_form" nowrap>&nbsp;<!--שם משפחה--><%=arrTitles(4)%>&nbsp;<span style="color:#FF0000">*</span></td>
	...
	<td align=left class="title_show_form" nowrap>&nbsp; שם פרטי באנגלית<%'=arrTitles(3)%>&nbsp;<span style="color:#FF0000">*</span></td>
	...
	<td align=left class="title_show_form" nowrap>&nbsp;שם משפחה באנגלית<%'=arrTitles(4)%>&nbsp;<span style="color:#FF0000">*</span></td>
</tr>
...
<tr>
	...
	<td align=left class="title_show_form" nowrap>&nbsp;<!--שם משתמש--><%=arrTitles(5)%>&nbsp;<span style="color:#FF0000">*</span></td>
	...
	<td align=left class="title_show_form" nowrap>&nbsp;<!--סיסמה--><%=arrTitles(6)%>&nbsp;<span style="color:#FF0000">*</span></td>
	...
	<td align=left class="title_show_form" nowrap>&nbsp;<!--טלפון--><%=arrTitles(8)%>&nbsp;</td>
	...
	<td align=left align="<%=align_var%>" class="title_show_form" nowrap><!--נייד-->נייד עבודה<%'=arrTitles(9)%>&nbsp;</td>
</tr>
<tr ><tD colspan=8 height=1 width=100% style="background-color:#ffffff"></tD></tr>
...
<tr>
	...
	<td align=left class="title_show_form" nowrap><!--נייד-->נייד פרטי<%'=arrTitles(9)%>&nbsp;</td>
	...
	<td align=left class="title_show_form" nowrap >&nbsp;<!--פקס--><%=arrTitles(10)%>&nbsp;</td>
	...
	<td align=left class="title_show_form" nowrap >&nbsp;<!--דואר אלקטרוני-->דואר אלקטרוני עבודה<%'=arrTitles(11)%>&nbsp;<span style="color:#FF0000">*</span></td>
	...
	<td align=left class="title_show_form" nowrap >&nbsp;דואר אלקטרוני פרטי<%'=arrTitles(11)%>&nbsp;</td>
</tr>
<tr ><tD colspan=8 height=1 width=100% style="background-color:#ffffff"></tD></tr>
...
<tr>
	...
	<td align=left class="title_show_form" nowrap >&nbsp;תאריך לידה&nbsp;</td>
</tr>
...
<tr>
	...
	<td  align="left" class="title_show_form" nowrap dir=rtl>"ביטוח מול "דיוויד שילד</td>
	...
	<td align="left" class="title_show_form" nowrap dir=rtl>מורשה העברה  טופס לארכיון /לטיפול חוזר</td>

<td align="<%=align_var%>"  nowrap><input type="checkbox" dir="ltr" name="chief" <%If trim(chief) = "1" Then%> checked <%End If%> ID="chief"></td>
	<td align="left" class="title_show_form" nowrap dir=rtl>&nbsp;מורשה מחיקה&nbsp;&nbsp;</td>
	...
	<td align="left" class="title_show_form" nowrap dir=rtl>&nbsp;מורשה כניסה רק מי-IP&nbsp;&nbsp;</td>
...
<tr>
	...
	<td align="left" class="title_show_form" nowrap dir=rtl valign=top>לעדכון שדה מעוניין בקבלת דיוור</td>
	...
	<td align="left" class="title_show_form" nowrap dir=rtl>מורשה לשליחת  אימייל קבוצתי </td>
	...
	<td align="left" class="title_show_form" nowrap dir=rtl>מורשה לשינוי תוכן הודעת sms </td>
	...
	<td  align="left" class="title_show_form" nowrap dir=rtl>רישום לטיולים של הקבוצות הסגורות</td>
...
<td colspan=2>&nbsp;</td>
	...
	<td align="left"  class="title_show_form" nowrap dir=rtl valign=top > מורשה לשחרור הנעילת משתמש </td>
	...
	<td align="<%=align_var%>"  class="title_show_form" nowrap dir=rtl valign=top style="background-color:FFCE42">מורשה לצפיה בדש בורד איש קשר&nbsp;&nbsp;</td>
	...
	<td align="left" class="title_show_form"  dir=rtl valign=top nowrap>הרשאת הקלדה אינטרנטית</td>
</tr>
...
<tr>
<td class="title_sort" align=center>טיים לימיטים</td>
<TD class="title_sort" align =center>קשרי לקוחות</TD>
<td class="title_sort" align =center>מסך טפסים וסקרים -<br> דוח מעקב רישום ואחוזי סגירה</td>
<td class="title_sort" align=center>מסך אופרציה</td>
<td class="title_sort" align=center>מסך משובים</td>
<td class="title_sort" align=center>מסך מיקודי טיולים</td>
<td class="title_sort" align=center>דש בורד מכירות</td>
</tr>
<tr><td valign=top bgcolor="#e6e6e6">
<table border=0 cellpadding=0 cellspacing=0  align=right ID="Table9">
<tr>
	<td align="<%=align_var%>" class="title_show_form" nowrap dir=rtl valign=top>חברת תעופה&nbsp;&nbsp;</td>
...
<tr>
	<td align="<%=align_var%>" class="title_show_form" nowrap dir=rtl valign=top>נמל טיסה&nbsp;&nbsp;</td>
...
<tr>
	<td align="<%=align_var%>" class="title_show_form" nowrap dir=rtl valign=top>סטטוס אישור מקומות טיסה&nbsp;&nbsp;</td>
...
<tr>
	<td align="<%=align_var%>" class="title_show_form" nowrap dir=rtl valign=top>מטבע עלות טיסה&nbsp;&nbsp;</td>
...
<tr>
	<td align="<%=align_var%>" class="title_show_form" nowrap dir=rtl valign=top>סטטוס טיסות&nbsp;&nbsp;</td>
...
<TD class="title_sort">קשרי לקוחות</TD>
<td valign=top bgcolor="#e6e6e6">
<table border=0 cellpadding=0 cellspacing=0  align=right ID="Table5">
<tr>
	<td align="right" class="title_show_form" nowrap  dir=rtl valign=top>הפקת דוח מעקב רישום</td>
...
<tr>
	<td align="right" class="title_show_form" nowrap dir=rtl valign=top>הפקת דוח  מגמות ביקושים ואחוזי סגירה</td>
...
<td valign=top bgcolor="#e6e6e6"><table border=0 cellpadding=0 cellspacing=0  align=right ID="Table14">
	<td align="right" class="title_show_form" nowrap dir=rtl valign=top>מורשה לצפיה בכל הטיולים  &nbsp;&nbsp;</td>
...
<tr><td align="right" class="title_show_form"  dir=rtl>מורשה לשליחת סמס ממסך מרכז משובים</td>
...
<tr>
<td align="<%=align_var%>" class="title_show_form"  dir=rtl>מורשה לשליחת סמס ממסך איש קשר &nbsp;&nbsp;</td>
<td align="right" ><input type="checkbox" dir="ltr" name="ScreenContactSendSms" <%If trim(ScreenContactSendSms) = "1" Then%> checked <%End If%> ID="ScreenContactSendSms"></td></tr>
...
<table border=0 cellpadding=0 cellspacing=0>
<tr>
	<td align="right" nowrap dir=rtl class="title_show_form">להציג טיול בתצוגה</td>
...
<tr>
	<td align="right" nowrap dir=rtl class="title_show_form">שינוי סטטוס </td>
...
<tr>
	<td align=right  dir=rtl class="title_show_form" nowrap>מורשה לשליחת  אימייל ממסך ההגדרות</td>
...
<tr>
	<td align=right  nowrap  dir=rtl class="title_show_form">מורשה לשינוי מיקום שורות במסך הצפיה </td>
...
<td valign=top bgcolor="#e6e6e6"><table border=0 cellpadding=0 cellspacing=0>
   <tr><td align=right  dir=rtl class="title_show_form" nowrap> מורשה שינוי שדה שיוך למחלקה בטופס רישום חתום</td>
<td nowrap align=left><input type="checkbox" dir="ltr" name="Edit_DepartmentAppeal" <%If trim(Edit_DepartmentAppeal) = "1" Then%> checked <%End If%> ID="Edit_DepartmentAppeal">
   </td></tr>
</table></td></tr>
...
<tr style="background-color:#ffffff">
	...
	<td align="<%=align_var%>" class="title_show_form" nowrap dir=rtl valign=top> מורשה לעדכון שדות  מסך הגדרות יעדים  &nbsp;&nbsp;</td>
	...
	<td align="<%=align_var%>" class="title_show_form" nowrap dir=rtl valign=top> מורשה לעדכון שדות שליטה חודשי / שנתי  &nbsp;&nbsp;</td>
...
<TR><td colspan=6 align =right></td>
...
<tr style="background-color:#ffffff">
	...
	<td align="right" class="title_show_form" nowrap dir=rtl valign=top>מורשה לשליחת מיילים של טיים לימיטים בשם משתמש אחר&nbsp;&nbsp;</td>
    <td align="right" nowrap><input type="checkbox" dir="ltr" name="UndoPNR" <%If trim(UndoPNR) = "1" Then%> checked <%End If%> ID="UndoPNR"></td>
	<td align="right" class="title_show_form" nowrap dir=rtl valign=top>ביטול נעילה PNR &nbsp;&nbsp;</td>
	...
	<td align="right" class="title_show_form" nowrap dir=rtl valign=top>הרשאת מחיקת שורה &nbsp;&nbsp;</td>
	...
	<td align="right" class="title_show_form" nowrap dir=rtl valign=top>הרשאת פתיחת שדות חדשים &nbsp;&nbsp;</td>
	...
	<td align="right" class="title_show_form" nowrap dir=rtl valign=top>הרשאות שינוי שדות &nbsp;&nbsp;</td>
...
<td align="right" colspan=2 class="title_show_form">דרגת חשיבות ידיעת המשוב</td>
</tr>
</table>
</td></tr>
<%'----------response.end%>
...
'	response.Write "i=" & i &"--parentTitle="&parentTitle &":old_parent="& old_parent &"<BR>"
	...
	End If	
%>
	<td class="form_titleNormal" align="right" colspan=2 ><input type=checkbox dir="ltr" name="is_visible<%=barParent%>" <%If trim(parentVisible) = "1" Then%> checked <%End If%> ID="is_visible<%=barParent%>" onclick="return check_all_bars(this,'<%=barParent%>')"></td>
	<td align="right" class="form_titleNormal" width=120  nowrap dir="<%=dir_obj_var%>"><%=parentTitle%>&nbsp;</td>
<%
	End If	
	End If
%>
	...
	<td align="<%=align_var%>" class="title_show_form" nowrap dir="<%=dir_obj_var%>"><%=barTitle%>&nbsp;</td>
<% 
