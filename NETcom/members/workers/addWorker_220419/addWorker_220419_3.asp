...
<tr>
	<td align="right" class="title_show_form" nowrap dir=rtl valign=top>שליחת מיילים בשם משתמש אחר</td>
...
<tr><td align="right" class="title_show_form"  dir=rtl>שליחת סמס ממסך מרכז משובים</td>
<td align="right" valign=top><input type="checkbox" dir="ltr" name="ScreenGeneralSendSms" <%If trim(ScreenGeneralSendSms) = "1" Then%> checked <%End If%> ID="ScreenGeneralSendSms"></td>
</tr>
<tr>
<td align="right" class="title_show_form"  dir=rtl>שליחת סמס ממסך איש קשר</td>
<td align="right" valign=top><input type="checkbox" dir="ltr" name="ScreenContactSendSms" <%If trim(ScreenContactSendSms) = "1" Then%> checked <%End If%> ID="ScreenContactSendSms"></td></tr>
...
<tr>
	<td align=right  dir=rtl class="title_show_form" nowrap>שליחת  אימייל ממסך ההגדרות</td>
...
<tr>
	<td align=right  nowrap  dir=rtl class="title_show_form"> שינוי מיקום שורות במסך הצפיה</td>
...
<td valign=top bgcolor="#e6e6e6" align=right><table border=0 cellpadding=0 cellspacing=0 align=right>
   <tr><td align=right  dir=rtl class="title_show_form" nowrap> שינוי שדה שיוך למחלקה <BR>בטופס רישום חתום</td>
<td  align=left valign=top><input type="checkbox" dir="ltr" name="Edit_DepartmentAppeal" <%If trim(Edit_DepartmentAppeal) = "1" Then%> checked <%End If%> ID="Edit_DepartmentAppeal">
   </td></tr>
   <tr >
	<td align="right" class="title_show_form" nowrap dir=rtl valign=top>עדכון שדות  מסך הגדרות יעדים</td>
	<td align="right"><input type="checkbox" dir="ltr" name="salesControl_Points_Edit" <%If trim(salesControl_Points_Edit) = "1" Then%> checked <%End If%> ID="salesControl_Points_Edit"></td>
	</tr><tr>
	<td align="right" class="title_show_form" nowrap dir=rtl valign=top>עדכון שדות שליטה חודשי / שנתי</td>
		<td align="right"><input type="checkbox" dir="ltr" name="salesControl_Edit" <%If trim(salesControl_Edit) = "1" Then%> checked <%End If%> ID="salesControl_Edit"></td>
...
<tr>
	<td align="right" class="title_show_form" dir=rtl>&nbsp;מורשה מחיקה&nbsp;</td>
<td align="left" ><input type="checkbox" dir="ltr" name="chief" <%If trim(chief) = "1" Then%> checked <%End If%> ID="chief"></td>

</tr>
<tr>	<td align="right" class="title_show_form"  dir=rtl valign=top nowrap>הקלדה אינטרנטית</td>
	<td align="left" ><input type="checkbox" dir="ltr" name="IsTypingClient" <%If trim(IsTypingClient) = "1" Then%> checked <%End If%> ID="IsTypingClient"></td>
</tr>
<tr>	<td align="right"  class="title_show_form" nowrap dir=rtl valign=top>שחרור הנעילת משתמש</td>
	<td align="right"><input type="checkbox" dir="ltr" name="UpdateFieldUserBlocked" <%If trim(UpdateFieldUserBlocked) = "1" Then%> checked <%End If%> ID="UpdateFieldUserBlocked"></td>
</tr>

<tr><td  align="right" class="title_show_form" nowrap dir=rtl>רישום לטיולים של הקבוצות הסגורות</td>
	<td align="right" ><input type="checkbox" dir="ltr" name="Add_GroupsTours" <%If trim(Add_GroupsTours) = "1" Then%> checked <%End If%> ID="Add_GroupsTours"></td>

</tr>
<tr>
	<td align="right" class="title_show_form"dir=rtl>שינוי תוכן הודעת sms</td>
	<td align="right" ><input type="checkbox" dir="ltr" name="Sms_Write" <%If trim(Sms_Write) = "1" Then%> checked <%End If%> ID="Sms_Write"></td>

</tr>
<tr>
	<td align="right" class="title_show_form" nowrap dir=rtl valign=top>לעדכון שדה מעוניין בקבלת דיוור</td>
	<td align="right"><input type="checkbox" dir="ltr" name="Edit_IsNewLetters" <%If trim(Edit_IsNewLetters) = "1" Then%> checked <%End If%> ID="Edit_IsNewLetters"></td>
</tr><tr>
	<td align="right" class="title_show_form" dir=rtl>שליחת  אימייל קבוצתי</td>

	<td align="right"><input type="checkbox" dir="ltr" name="EmailGroupSend" <%If trim(EmailGroupSend) = "1" Then%> checked <%End If%> ID="EmailGroupSend"></td>

</tr>
<tr>	<td align="right"  class="title_show_form" nowrap dir=rtl valign=top>מורשה לצפיה בדש בורד איש קשר</td>
	<td align="right"><input type="checkbox" dir="ltr" name="DashBoardView" <%If trim(DashBoardView) = "1" Then%> checked <%End If%> ID="DashBoardView"></td>
</tr>
...
<%End If%>
<tr><td height=5 nowrap colspan=3></td></tr>
<tr><td class="title" align="<%=align_var%>" colspan=3><!--הרשאות-->הרשות כניסה למודולים&nbsp;&nbsp;<span style="font-weight:500"><%=arrTitles(22)%></span></td></tr>
