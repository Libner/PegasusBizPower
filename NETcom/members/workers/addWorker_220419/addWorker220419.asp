...
If Len(USER_ID) > 0 Then
	...
	"EMAIL_PRIVATE,MOBILE_PRIVATE,BIRTHDAY,isNull(UpdateFieldUserBlocked,0)	 FROM dbo.USERS WHERE USER_ID=" & USER_ID  
	'Response.Write sqlStr
	'response.end
...
<tr>
<td width=50% align="right"><input type=button class="but_menu" style="width:90px" onclick="document.location.href='default.asp';" value="<%=arrButtons(2)%>" id="Button3" name=Button2></td>
...
<tr><td colspan=2 align=right><table border=0 cellpadding=1 cellspacing=0  align=right ID="Table2">
<tr>
...
<%	rs_jobs.moveNext
	...
	<th align=left class="title_show_form" nowrap >&nbsp;<!--עיסוק--><%=arrTitles(7)%>&nbsp;<span style="color:#FF0000">*</span></td>
	<td align="<%=align_var%>" nowrap>
...
<%	rs_dep.moveNext
	...
	<th align="left" class="title_show_form" nowrap>&nbsp;שיוך למחלקה&nbsp;</td>
	<td align="<%=align_var%>" nowrap><input type=text dir="ltr" name="Month_Min_Order" value="<%=vfix(Month_Min_Order)%>" size="3" maxlength="3" style="font-family:arial" onkeypress="GetNumbers();" ID="Text1"></td>
	<th align="left"  class="title_show_form" nowrap>&nbsp;יעד הזמנות מינימלי&nbsp;</th>

	<td align="<%=align_var%>"  nowrap><input type="text" size="3" maxlength="3" dir="ltr" style="font-family:arial" name="Order_Price" value="<%=nFix(Order_Price)%>" ID="Order_Price"></td>
	<th align="left"  class="title_show_form" nowrap dir=rtl>&nbsp;שווי כספי של הזמנה&nbsp;&nbsp;</th>
</tr>
<tr ><tD colspan=8 height=1 width=100% ></tD></tr>
<tr>
	<td align="<%=align_var%>" nowrap><input type=text dir="<%=dir_obj_var%>" name="FIRSTNAME" value="<%=vFix(FIRSTNAME)%>"  style="width:150" maxlength=20 style="font-family:arial"></td>
	<th align=left class="title_show_form" nowrap>&nbsp;<!--שם פרטי--><%=arrTitles(3)%>&nbsp;<span style="color:#FF0000">*</span></td>
	<td align="<%=align_var%>"  nowrap><input type=text dir="<%=dir_obj_var%>" name="LASTNAME" value="<%=vFix(LASTNAME)%>"  style="width:150" maxlength=20 style="font-family:arial"></td>
	<th align=left class="title_show_form" nowrap>&nbsp;<!--שם משפחה--><%=arrTitles(4)%>&nbsp;<span style="color:#FF0000">*</span></td>
	<td align="<%=align_var%>" nowrap><input type=text dir="ltr" name="FIRSTNAME_ENG" value="<%=vFix(FIRSTNAME_ENG)%>"  style="width:150" maxlength=20 style="font-family:arial" ></td>
	<th align=left class="title_show_form" nowrap>&nbsp; שם פרטי באנגלית<%'=arrTitles(3)%>&nbsp;<span style="color:#FF0000">*</span></td>
	<td align="<%=align_var%>" nowrap><input type=text dir="ltr>" name="LASTNAME_ENG" value="<%=vFix(LASTNAME_ENG)%>"  style="width:150" maxlength=20 style="font-family:arial"></td>
	<th align=left class="title_show_form" nowrap>&nbsp;שם משפחה באנגלית<%'=arrTitles(4)%>&nbsp;<span style="color:#FF0000">*</span></td>
</tr>
<tr ><tD colspan=8 height=1 width=100% style="background-color:#ffffff"></tD></tr>

<tr>
	<td align="<%=align_var%>"  nowrap><input type=text dir="ltr" name="LOGINNAME" value="<%=vFix(LOGINNAME)%>"  style="width:150" maxlength=20 style="font-family:arial"></td>
	<th align=left class="title_show_form" nowrap>&nbsp;<!--שם משתמש--><%=arrTitles(5)%>&nbsp;<span style="color:#FF0000">*</span></td>
	<td align="<%=align_var%>"  nowrap><input type=text dir="ltr" name="PASSWORD" value="<%=vFix(PASSWORD_U)%>"  style="width:150" maxlength=20 style="font-family:arial"></td>
	<th align=left class="title_show_form" nowrap>&nbsp;<!--סיסמה--><%=arrTitles(6)%>&nbsp;<span style="color:#FF0000">*</span></td>
	<td align="<%=align_var%>"  nowrap><input type=text dir="ltr" name="phone" value="<%=vfix(phone)%>"  style="width:150" maxlength=20 style="font-family:arial"></td>
	<th align=left class="title_show_form" nowrap>&nbsp;<!--טלפון--><%=arrTitles(8)%>&nbsp;</th>
	<td align="<%=align_var%>"  nowrap><input type=text dir="ltr" name="mobile" value="<%=vfix(mobile)%>"  style="width:150" maxlength=20 style="font-family:arial"></td>
	<th align=left align="<%=align_var%>" class="title_show_form" nowrap><!--נייד-->נייד עבודה<%'=arrTitles(9)%>&nbsp;</th>
</tr>
<tr ><tD colspan=8 height=1 width=100% style="background-color:#ffffff"></tD></tr>

<tr>
	<td align="<%=align_var%>"  nowrap><input type=text dir="ltr" name="mobilePrivate" value="<%=vfix(mobilePrivate)%>"  style="width:150" maxlength=20 style="font-family:arial" ID="mobilePrivate"></td>
	<th align=left class="title_show_form" nowrap><!--נייד-->נייד פרטי<%'=arrTitles(9)%>&nbsp;</th>

	<td align="<%=align_var%>" nowrap><input type=text dir="ltr" name="fax" value="<%=vfix(fax)%>"  style="width:150" maxlength=20 style="font-family:arial"></td>
	<th align=left class="title_show_form" nowrap >&nbsp;<!--פקס--><%=arrTitles(10)%>&nbsp;</th>
	<td align="<%=align_var%>" nowrap><input type=text dir="ltr" name="email" value="<%=vfix(email)%>"  style="width:150" maxlength=100 style="font-family:arial"></td>
	<th align=left class="title_show_form" nowrap >&nbsp;<!--דואר אלקטרוני-->דואר אלקטרוני עבודה<%'=arrTitles(11)%>&nbsp;<span style="color:#FF0000">*</span></th>
	<td align="<%=align_var%>" nowrap><input type=text dir="ltr" name="emailPrivate" value="<%=vfix(emailPrivate)%>"  style="width:150" maxlength=100 style="font-family:arial" ID="emailPrivate"></td>
	<th align=left class="title_show_form" nowrap >&nbsp;דואר אלקטרוני פרטי<%'=arrTitles(11)%>&nbsp;</th>
</tr>
<tr ><tD colspan=8 height=1 width=100% style="background-color:#ffffff"></tD></tr>

<tr>
	<td align="<%=align_var%>" nowrap colspan=7>
	...
	<th align=left class="title_show_form" nowrap >&nbsp;תאריך לידה&nbsp;</th>
</tr>
...
<tr>
	...
	<td align="<%=align_var%>"  nowrap><input type="checkbox" dir="ltr" name="Add_Insurance" <%If trim(Add_Insurance) = "1" Then%> checked <%End If%> ID="Add_Insurance"></td>
	<th  align="left" class="title_show_form" nowrap dir=rtl>"ביטוח מול "דיוויד שילד</th>
		<td align="<%=align_var%>"  nowrap><input type="checkbox" dir="ltr" name="arch_app" <%If trim(arch_app) = "1" Then%> checked <%End If%> ID="arch_app"></td>
	<th align="left" class="title_show_form" nowrap dir=rtl>מורשה העברה  טופס לארכיון /לטיפול חוזר</th>

<td align="<%=align_var%>"  nowrap><input type="checkbox" dir="ltr" name="chief" <%If trim(chief) = "1" Then%> checked <%End If%> ID="chief"></td>
	<th align="left" class="title_show_form" nowrap dir=rtl>&nbsp;מורשה מחיקה&nbsp;&nbsp;</th>

	<td align="<%=align_var%>" nowrap><input type="checkbox" dir="ltr" name="IP_login" <%If trim(IP_login) = "1" Then%> checked <%End If%> ID="IP_login"></td>
	<th align="left" class="title_show_form" nowrap dir=rtl>&nbsp;מורשה כניסה רק מי-IP&nbsp;&nbsp;</th>
...
<tr>
	...
	<td align="<%=align_var%>"  nowrap><input type="checkbox" dir="ltr" name="Edit_IsNewLetters" <%If trim(Edit_IsNewLetters) = "1" Then%> checked <%End If%> ID="Edit_IsNewLetters"></td>
	<th align="left" class="title_show_form" nowrap dir=rtl valign=top>לעדכון שדה מעוניין בקבלת דיוור</th>
	<td align="<%=align_var%>"  nowrap><input type="checkbox" dir="ltr" name="EmailGroupSend" <%If trim(EmailGroupSend) = "1" Then%> checked <%End If%> ID="EmailGroupSend"></td>
	<th align="left" class="title_show_form" nowrap dir=rtl>מורשה לשליחת  אימייל קבוצתי </th>

	<td align="<%=align_var%>"  nowrap><input type="checkbox" dir="ltr" name="Sms_Write" <%If trim(Sms_Write) = "1" Then%> checked <%End If%> ID="Sms_Write"></td>
	<th align="left" class="title_show_form" nowrap dir=rtl>מורשה לשינוי תוכן הודעת sms </th>


	<td align="<%=align_var%>"  nowrap><input type="checkbox" dir="ltr" name="Add_GroupsTours" <%If trim(Add_GroupsTours) = "1" Then%> checked <%End If%> ID="Add_GroupsTours"></td>
	<th  align="left" class="title_show_form" nowrap dir=rtl>רישום לטיולים של הקבוצות הסגורות</th>

</tr>
<tr>
<td colspan=2>&nbsp;</td>
	<td align="right" nowrap ><input type="checkbox" dir="ltr" name="UpdateFieldUserBlocked" <%If trim(UpdateFieldUserBlocked) = "1" Then%> checked <%End If%> ID="UpdateFieldUserBlocked"></td>
	<th align="left"  class="title_show_form" nowrap dir=rtl valign=top > מורשה לשחרור הנעילת משתמש </th>


	<td align="right" nowrap style="background-color:FFCE42"><input type="checkbox" dir="ltr" name="DashBoardView" <%If trim(DashBoardView) = "1" Then%> checked <%End If%> ID="DashBoardView"></td>
	<th align="<%=align_var%>"  class="title_show_form" nowrap dir=rtl valign=top style="background-color:FFCE42">מורשה לצפיה בדש בורד איש קשר&nbsp;&nbsp;</th>

	<td align="right" ><input type="checkbox" dir="ltr" name="IsTypingClient" <%If trim(IsTypingClient) = "1" Then%> checked <%End If%> ID="IsTypingClient"></td>
	<th align="left" class="title_show_form"  dir=rtl valign=top nowrap>הרשאת הקלדה אינטרנטית</th>
</tr>
...
<tr><tD colspan=8 height=1 width=100% style="background-color:#ffffff"></tD></tr>
<%'response.end%>
<TR><td colspan=6 align =right><table border=0 cellpadding=0 cellspacing=0  align=right>
<tr style="background-color:#ffffff">
	<th align="right" class="title_show_form" nowrap  dir=rtl>מורשה שינוי שדה שיוך למחלקה בטופס רישום חתום&nbsp;&nbsp;</th>
	<td align=right nowrap><input type="checkbox" dir="ltr" name="Edit_DepartmentAppeal" <%If trim(Edit_DepartmentAppeal) = "1" Then%> checked <%End If%> ID="Edit_DepartmentAppeal"></td>

</tr></table></td>
<td  align="right" class="title" colspan=2><font size=2>דש בורד מכירות</font></td>
</tR>
<tr><tD colspan=8 height=1 width=100% style="background-color:#ffffff"></tD></tr>
<TR><td colspan=6 align =right><table border=0 cellpadding=2 cellspacing=0  align=right ID="Table6">
<tr style="background-color:#ffffff">
	<th align=right  nowrap  dir=rtl class="title_show_form">מורשה לשינוי מיקום שורות במסך הצפיה </th>
	<td nowrap align=left><input type="checkbox" dir="ltr" name="ScreenTourOrder" <%If trim(ScreenTourOrder) = "1" Then%> checked <%End If%> ID="ScreenTourOrder"></td>
	<th align=right  dir=rtl class="title_show_form" nowrap>מורשה לשליחת  אימייל ממסך ההגדרות</th>
	<td  nowrap align=left><input type="checkbox" dir="ltr" name="ScreenSendMail" <%If trim(ScreenSendMail) = "1" Then%> checked <%End If%> ID="ScreenSendMail"></td>
	<th align="right" nowrap dir=rtl class="title_show_form">שינוי סטטוס </th>
	<td  nowrap align=left><input type="checkbox" dir="ltr" name="ScreenTourStatus" <%If trim(ScreenTourStatus) = "1" Then%> checked <%End If%> ID="ScreenTourStatus"></td>
	<th align="right" nowrap dir=rtl class="title_show_form">להציג טיול בתצוגה</th>
	<td nowrap align=left><input type="checkbox" dir="ltr" name="Screen_TourVisible" <%If trim(Screen_TourVisible) = "1" Then%> checked <%End If%> ID="Screen_TourVisible"></td>
</tr>
</table></td>
<td align="right" class="title" colspan=2><font size=2>מסך מיקודי טיולים</font></td>
</tR>
<tr><tD colspan=8 height=1 width=100% style="background-color:#ffffff"></tD></tr>

<TR><td colspan=6 align =right><table border=0 cellpadding=2 cellspacing=0  align=right ID="Table3">
<tr style="background-color:#ffffff">
<th align="<%=align_var%>" class="title_show_form"  dir=rtl>מורשה לשליחת סמס ממסך איש קשר &nbsp;&nbsp;</th>
<td align="right" ><input type="checkbox" dir="ltr" name="ScreenContactSendSms" <%If trim(ScreenContactSendSms) = "1" Then%> checked <%End If%> ID="ScreenContactSendSms"></td>
<th align="right" class="title_show_form"  dir=rtl>מורשה לשליחת סמס ממסך מרכז משובים</th>
<td align="<%=align_var%>"><input type="checkbox" dir="ltr" name="ScreenGeneralSendSms" <%If trim(ScreenGeneralSendSms) = "1" Then%> checked <%End If%> ID="ScreenGeneralSendSms"></td>
</tr>
</table></td>
<td align="right" class="title" colspan=2><font size=2>מסך משובים</font></td>
</tR>
<tr><tD colspan=8 height=1 width=100% style="background-color:#ffffff"></tD></tr>

<TR><td colspan=6 align =right><table border=0 cellpadding=2 cellspacing=0  align=right ID="Table7">
<tr style="background-color:#ffffff">
	<th align="right" class="title_show_form" nowrap dir=rtl valign=top>מורשה לצפיה בכל הטיולים  &nbsp;&nbsp;</th>
	<td align="right"  nowrap><input type="checkbox" dir="ltr" name="OperationScreenView" <%If trim(OperationScreenView) = "1" Then%> checked <%End If%> ID="OperationScreenView"></td>
</tr>
</table></td>
<td align="right" class="title" colspan=2><font size=2>מסך אופרציה</font></td>
</tR>
<tr><tD colspan=8 height=1 width=100% style="background-color:#ffffff"></tD></tr>

<TR><td colspan=6 align =right><table border=0 cellpadding=2 cellspacing=0  align=right ID="Table5">
<tr style="background-color:#ffffff">
	<th align="right" class="title_show_form" nowrap dir=rtl valign=top>הפקת דוח  מגמות ביקושים ואחוזי סגירה</th>
	<td align="right"  nowrap><input type="checkbox" dir="ltr" name="ReportCloseProcView" <%If trim(ReportCloseProcView) = "1" Then%> checked <%End If%> ID="ReportCloseProcView"></td>
	<th align="right" class="title_show_form" nowrap  dir=rtl valign=top>הפקת דוח מעקב רישום</th>
	<td align="right"  nowrap><input type="checkbox" dir="ltr" name="ReportMaakavRishumView" <%If trim(ReportMaakavRishumView) = "1" Then%> checked <%End If%> ID="ReportMaakavRishumView"></td>
</table></td>
<td align="right" class="title" colspan=2><font size=2>מסך טפסים וסקרים - דוח מעקב רישום ואחוזי סגירה</font></td>
</tR>
<tr><tD colspan=8 height=1 width=100% style="background-color:#ffffff"></tD></tr>
<TR><td colspan=8 align =right><table border=0 cellpadding=2 cellspacing=0  align=right ID="Table4">
<tr  style="background-color:FFCE42">
	<td align="right" nowrap><input type="checkbox" dir="ltr" name="ScreenContactSendSms" <%If trim(ScreenContactSendSms) = "1" Then%> checked <%End If%> ID="Checkbox1"></td>
	<th align="right" class="title_show_form" nowrap  dir=rtl>מורשה לשליחת סמס ממסך איש קשר &nbsp;&nbsp;</th>
</table></td>
</tr>
<tr><tD colspan=8 height=1 width=100% style="background-color:#ffffff"></tD></tr>


<TR><td colspan=6 align =right><table border=0 cellpadding=2 cellspacing=0  align=right ID="Table8">
<tr style="background-color:#ffffff">
	<td align="<%=align_var%>" nowrap><input type="checkbox" dir="ltr" name="salesControl_Points_Edit" <%If trim(salesControl_Points_Edit) = "1" Then%> checked <%End If%> ID="salesControl_Points_Edit"></td>
	<th align="<%=align_var%>" class="title_show_form" nowrap dir=rtl valign=top> מורשה לעדכון שדות  מסך הגדרות יעדים  &nbsp;&nbsp;</th>

	<td align="<%=align_var%>" nowrap><input type="checkbox" dir="ltr" name="salesControl_Edit" <%If trim(salesControl_Edit) = "1" Then%> checked <%End If%> ID="salesControl_Edit"></td>
	<th align="<%=align_var%>" class="title_show_form" nowrap dir=rtl valign=top> מורשה לעדכון שדות שליטה חודשי / שנתי  &nbsp;&nbsp;</th>

</table></td>
<td align="right" class="title" colspan=2><font size=2>מסך מכירות</font></td>
</tR>

<tr><tD colspan=8 height=1 width=100% style="background-color:#ffffff"></tD></tr>


<TR><td colspan=6 align =right><table border=0 cellpadding=2 cellspacing=0  align=right ID="Table9">
<tr style="background-color:#ffffff">
	<td align="<%=align_var%>" nowrap><input type="checkbox" dir="ltr" name="EditFlightStatus" <%If trim(EditFlightStatus) = "1" Then%> checked <%End If%> ID="Checkbox6"></td>
	<th align="<%=align_var%>" class="title_show_form" nowrap dir=rtl valign=top>סטטוס טיסות&nbsp;&nbsp;</th>
	<td align="<%=align_var%>" nowrap><input type="checkbox" dir="ltr" name="EditCurrency" <%If trim(EditCurrency) = "1" Then%> checked <%End If%> ID="Checkbox5"></td>
	<th align="<%=align_var%>" class="title_show_form" nowrap dir=rtl valign=top>מטבע עלות טיסה&nbsp;&nbsp;</th>
	<td align="<%=align_var%>" nowrap><input type="checkbox" dir="ltr" name="EditApprovalStatus" <%If trim(EditApprovalStatus) = "1" Then%> checked <%End If%> ID="EditApprovalStatus"></td>
	<th align="<%=align_var%>" class="title_show_form" nowrap dir=rtl valign=top>סטטוס אישור מקומות טיסה&nbsp;&nbsp;</th>
	<td align="<%=align_var%>" nowrap><input type="checkbox" dir="ltr" name="EditAirports" <%If trim(EditAirports) = "1" Then%> checked <%End If%> ID="EditAirports"></td>
	<th align="<%=align_var%>" class="title_show_form" nowrap dir=rtl valign=top>נמל טיסה&nbsp;&nbsp;</th>
	<td align="<%=align_var%>" nowrap><input type="checkbox" dir="ltr" name="EditFlyCompanies" <%If trim(EditFlyCompanies) = "1" Then%> checked <%End If%> ID="EditFlyCompanies"></td>
	<th align="<%=align_var%>" class="title_show_form" nowrap dir=rtl valign=top>חברת תעופה&nbsp;&nbsp;</th>
	</tr>
</table></td>
<td align="right" class="title" colspan=2><font size=2>טיים לימיטים</font></td>
</tr>
<tr><tD colspan=8 height=1 width=100% style="background-color:#ffffff"></tD></tr>
<TR><td colspan=6 align =right><table border=0 cellpadding=2 cellspacing=0  align=right ID="Table10">
<tr style="background-color:#ffffff">
	<td align="right" nowrap><input type="checkbox" dir="ltr" name="IsSendFromTL" <%If trim(IsSendFromTL) = "1" Then%> checked <%End If%> ID="IsSendFromTL"></td>
	<th align="right" class="title_show_form" nowrap dir=rtl valign=top>מורשה לשליחת מיילים של טיים לימיטים בשם משתמש אחר&nbsp;&nbsp;</th>
    <td align="right" nowrap><input type="checkbox" dir="ltr" name="UndoPNR" <%If trim(UndoPNR) = "1" Then%> checked <%End If%> ID="UndoPNR"></td>
	<th align="right" class="title_show_form" nowrap dir=rtl valign=top>ביטול נעילה PNR &nbsp;&nbsp;</th>
    <td align="right" nowrap><input type="checkbox" dir="ltr" name="DeleteRowMainData" <%If trim(DeleteRowMainData) = "1" Then%> checked <%End If%> ID="DeleteRowMainData"></td>
	<th align="right" class="title_show_form" nowrap dir=rtl valign=top>הרשאת מחיקת שורה &nbsp;&nbsp;</th>
	<td align="right" nowrap><input type="checkbox" dir="ltr" name="InsertRowMainData" <%If trim(InsertRowMainData) = "1" Then%> checked <%End If%> ID="InsertRowMainData"></td>
	<th align="right" class="title_show_form" nowrap dir=rtl valign=top>הרשאת פתיחת שדות חדשים &nbsp;&nbsp;</th>
    <td align="right" nowrap><input type="checkbox" dir="ltr" name="EditMainData" <%If trim(EditMainData) = "1" Then%> checked <%End If%> ID="EditMainData"></td>
	<th align="right" class="title_show_form" nowrap dir=rtl valign=top>הרשאות שינוי שדות &nbsp;&nbsp;</th>

</tr>
</table></td>
<td align="right" class="title" colspan=2><font size=2>מסך שליטה ראשי של מערכת הטיסות</font></td>
</tr>
<tr><tD colspan=8 height=1 width=100% style="background-color:#ffffff"></tD></tr>

<TR><td colspan=6 align =right><table border=0 cellpadding=2 cellspacing=0  align=right ID="Table11">
<tr style="background-color:#ffffff"><td align="right" nowrap>
...
<th align="right" colspan=2 class="title_show_form">דרגת חשיבות ידיעת המשוב</th>
</tr>
</table>
</td></tr>
<%'----------response.end%>
...
'	response.Write "i=" & i &"--parentTitle="&parentTitle &":old_parent="& old_parent &"<BR>"
	...
	End If	
%>
	<th class="form_titleNormal" align="right" colspan=2 ><input type=checkbox dir="ltr" name="is_visible<%=barParent%>" <%If trim(parentVisible) = "1" Then%> checked <%End If%> ID="is_visible<%=barParent%>" onclick="return check_all_bars(this,'<%=barParent%>')"></th>
	<th align="right" class="form_titleNormal" width=120  nowrap dir="<%=dir_obj_var%>"><%=parentTitle%>&nbsp;</th>
<%
	End If	
	End If
%>
	...
	<th align="<%=align_var%>" class="title_show_form" nowrap dir="<%=dir_obj_var%>"><%=barTitle%>&nbsp;</th>
<% 
