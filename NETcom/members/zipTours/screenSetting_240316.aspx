...
<%IF ViewColumn(6)=true then%><td align=center>1</td><%end if%>
<%IF ViewColumn(7)=true then%><td>1</td><%end if%>
<%IF ViewColumn(8)=true then%><td>1</td><%end if%>
<%IF ViewColumn(9)=true then%><td>1</td><%end if%>
<%IF ViewColumn(10)=true then%><td>1</td><%end if%>

<%IF ViewColumn(5)=true then%><td align=center><%#Container.DataItem("Dep_Name")%></td><%end if%>
<%IF ViewColumn(4)=true then%><td align=center><%#Container.DataItem("CountMembers")%></td><%end if%>
