...
Public Class screenView
    ...
    Protected rptTitleCount As Integer
...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If Not Page.IsPostBack Then
            cmdSelect = New SqlClient.SqlCommand("SELECT  Column_Id,Column_Name  FROM ScreenSetting where Column_Visible=1 order by Column_Order desc", con)
            ...
            rptTitle.DataBind()
            con.Close()
            rptTitleCount = rptTitle.Items.Count() + 1
            ...
            If ViewColumn(5) = True Then
                GettDepartments()
            End If
            If ViewColumn(11) = True Then
                GetUsers()
            End If
            If ViewColumn(14) = True Then
                GetCountries()
            End If
            bindList()
        End If
    ...
    Public Sub bindList()
        ...
        Else
            cmdSelect.Parameters.Add("@fromDate", SqlDbType.VarChar, 30).Value = ""
            cmdSelect.Parameters.Add("@toDate", SqlDbType.VarChar, 30).Value = ""
        End If
    ...
    Private Sub rptCustomers_ItemDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.RepeaterItemEventArgs) Handles rptCustomers.ItemDataBound
        If e.Item.ItemType = ListItemType.Item Or e.Item.ItemType = ListItemType.AlternatingItem Then
            ...
            If e.Item.DataItem("zipTourOrder") = "1" Then
    ...
    Private Sub btnSaveChecked_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSaveChecked.Click
        saveChekedTours()
        Response.Redirect("screenView.aspx")
    End Sub
    Sub saveChekedTours()
        ...
        For i = 0 To j - 1
            ...
            If chk.Checked Then
                ...
                cmd = New System.Data.SqlClient.SqlCommand("Update Tours_Departures set zipTourOrder=1 where Departure_Id=@chkValue ", conPegasus)
            ...
            Else
                ...
                cmd = New System.Data.SqlClient.SqlCommand("Update Tours_Departures set zipTourOrder=0 where Departure_Id=@chkValue ", conPegasus)
                cmd.CommandType = CommandType.Text
                cmd.Parameters.Add("@chkValue", SqlDbType.Int).Value = CInt(chk.Value())
                'cmd.Parameters.Add("@ProfId", SqlDbType.Int).Value = CInt(chk.Attributes("value"))
                cmd.ExecuteNonQuery()
