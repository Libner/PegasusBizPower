...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If Not Page.IsPostBack Then
            cmdSelect = New SqlClient.SqlCommand("SELECT    Column_Id, Column_Name,  Column_Visible  FROM ScreenSetting  order by Column_Id", con)
    ...
    Sub saveGeneral()
        ...
        For i = 0 To dtlGeneral.Items.Count - 1
            ...
            If chk.Checked Then
                con.Open()
                Dim cmd = New System.Data.SqlClient.SqlCommand("update ScreenSetting set Column_Visible=1 where column_id=@Id", con)
                cmd.CommandType = CommandType.Text
            ...
            Else
                con.Open()
                Dim cmd = New System.Data.SqlClient.SqlCommand("update ScreenSetting set Column_Visible=0 where column_id=@Id", con)
                cmd.CommandType = CommandType.Text
