Public Class editStatus
    ...
    Protected sdep, sUser, sSer, sPage, sSt As Integer
...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Else
            ...
            cScript += "self.close();window.opener.location.href = 'screenSetting.aspx?sdep=" & sdep & "&sUser=" & sUser & "&sSer=" & sSer & "&sFromD=" & sFromD & "&sToD=" & sToD & "&sPage=" & sPage & "&sStatus=" & sSt & " '</script>"
