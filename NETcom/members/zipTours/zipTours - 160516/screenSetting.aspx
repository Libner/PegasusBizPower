...
{
var sUser,dep,sSer,sFromD,sToD,sPage,sStatus
sUser=$("#sUsers").val()
...
sStatus=$("#sStatus").val()
	...
	newWin=window.open("editStatus.aspx?DepartureId=" + escape(departureId) +"&sdep="+ escape(sdep) +"&sUser="+ escape(sUser) +"&sSer=" + escape(sSer) +"&sFromD="+ escape(sFromD) +"&sToD="+ escape(sToD) +"&sPage=" + escape(sPage)+ "&sStatus=" + escape(sStatus), "newWin", "toolbar=0,menubar=0,width=300,height=100,top=100,left=5,scrollbars=auto");
...
<td align=right>
<a href="#" class="link_categ" onclick="openStatus('<%#Container.DataItem("Departure_Id")%>');return false" title="עדכון סטטוס" style="cursor:hand"><img src="../../images/edit_icon.gif" border="0" style="margin-left:1px;"></a></td>
</tr></table></td><%'end if%>
