...
<td align=right>
<select id="slTour" runat=server name="slTour" dir=rtl  onchange="javascript:updStatus(this.value)">
</select>
</td>
</tr></table></td><%'end if%>
...
<tr><td align=right><span style="color:#000000">&nbsp;<%'#Container.DataItem("Status_Name")%>&nbsp;</span></td>
<td align=right>
<select id=slTour runat=server name="slTour" dir="rtl" onchange="javascript:updStatus(this.value)"></select>
</td>
</tr></table></td><%'end if%>
<td align=center> <input type="checkbox" ID="chkTour" Runat="server"  NAME="chkTour" ></td>
<%if false then%>
