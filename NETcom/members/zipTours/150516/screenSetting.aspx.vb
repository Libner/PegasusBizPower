...
Public Class screenSetting
    ...
    Public primKeydtStatus(0), primKeydtSeries(0), primKeydtDepartments(0), primKeydtUsers(0) As Data.DataColumn
...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If Not Page.IsPostBack Then
            cmdSelect = New SqlClient.SqlCommand("SELECT Column_Name  FROM ScreenSetting order by Column_Id desc", con)
    ...
    Private Sub rptCustomers_ItemDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.RepeaterItemEventArgs) Handles rptCustomers.ItemDataBound
        If e.Item.ItemType = ListItemType.Item Or e.Item.ItemType = ListItemType.AlternatingItem Then
            ...
            '   Response.Write("l=" & dtStatus.Rows.Count)
            Dim slTour As HtmlSelect
            slTour = e.Item.FindControl("slTour")

            slTour.Items.Clear()
            Dim list1 As New ListItem("הכל", "0")
            slTour.Items.Add(list1)
            For i As Integer = 0 To dtStatus.Rows.Count - 1
                Dim list As New ListItem(dtStatus.Rows(i)("status_Name"), e.Item.DataItem("Departure_id") & "-" & dtStatus.Rows(i)("status_id"))
                If e.Item.DataItem("Status_id") = dtStatus.Rows(i)("status_id") Then
                    list.Attributes.Add("style", "background-color:" & dtStatus.Rows(i)("status_Color") & ";color:" & dtStatus.Rows(i)("status_FntColor"))
                    list.Selected = True
                Else
                    list.Attributes.Add("style", "background-color:" & dtStatus.Rows(i)("status_Color") & ";color:" & dtStatus.Rows(i)("status_FntColor"))
