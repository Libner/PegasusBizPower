...
<%reqprodid = trim(Request.QueryString("prodId"))
	 ...
	 If trim(Request.QueryString("archProd")) = "1" Then 'move mail to the archive
			con.ExecuteQuery("Exec dbo.moveProductIntoArch @ProductID="&reqprodid & ", @OrgID=" & trim(OrgID) )
	 End If
	...
	If not rs_org.eof Then
		...
		Date_curr_add = DateAdd("m", number_of_month, date_add)		 
		
		If DateDIFF("d", Date_curr_add, Date()) > 0 Then
			Date_curr_add = DateAdd("m", 1, Date_curr_add)
		End If
...
<td width="100%" valign="top">
	...
	<tr>
		...
		<td valign="top" class="title_sort" align="center">העבר לארכיון</td>
...
<tr>
	...
	<td align="center" class="card" nowrap>&nbsp;<a href="products.asp?prodId=<%=prod_Id%>&archProd=1" ONCLICK="return CheckArchive()"><IMG SRC="../../images/down.gif" border="0" alt="העבר לארכיון"></a>&nbsp;</td>
...
<tr><td colspan=2 align="center"><a class="button_edit_1" style="width:84;line-height:11pt;padding:2pt;" href='products_arch.asp'>ארכיון הפצות</a></td></tr>
