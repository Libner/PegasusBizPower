...
<!--
	...
	function openresponse(responseID,prodID)
	{
		h = 470;
		w = 600;
		S_Wind = window.open("addresponsetest.asp?responseID=" + responseID + "&prodID=" + prodID, "S_Wind" ,"scrollbars=1,toolbar=0,top=150,left=50,width="+w+",height="+h+",align=center,resizable=1");
		S_Wind.focus();	
		return false;
	}	
//-->
