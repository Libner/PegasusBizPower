<%@ Page Language="vb" AutoEventWireup="false" Codebehind="SendTest.aspx.vb" Inherits="bizpower_pegasus.SendTest"%>
...
<HTML>
	...
	<BODY onload="window.focus();">
		<form id="form1" name="form1" method="post" runat="server">
			<input type="hidden" id="hdnemailLimit" runat="server" NAME="hdnemailLimit"> <input type="hidden" id="hdnUseBizLogo" runat="server" NAME="hdnUseBizLogo">
			<input type="hidden" id="hdnPageLang" runat="server" NAME="hdnPageLang"> <input type="hidden" id="hdnfirst_slice" runat="server" NAME="hdnfirst_slice">
			<input type="hidden" id="hdnsecond_slice" runat="server" NAME="hdnsecond_slice"> <input type="hidden" id="hdnpagesource" runat="server" NAME="hdnpagesource">
