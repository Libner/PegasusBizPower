...
<table border="0" width="100%" bgcolor="#FFFFFF" cellspacing="0" cellpadding="0" dir="<%=dir_var%>">
   <tr>    
	...
	<td width=50 nowrap align="center" valign="bottom" class="title_sort" name="status_td" id="status_td"><span id=word7 name=word7 dir="<%=dir_obj_var%>" ><!--סט'--><%=arrTitles(7)%></span>&nbsp;</td>
	</tr>
<%
