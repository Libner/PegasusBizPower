<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="default_withoutLogs.aspx.vb" Inherits="bizpower_pegasus2018.adminRegistrationScreen"%>
									...
									<table border="0" cellpadding="1" cellspacing="1" width="100%" dir="rtl">
										<tr bgcolor="#d8d8d8" id="blockSearchTerms">
											...
											<td class="td_admin_5" nowrap width="100">
												<input runat="server" id="sCountSendings" dir="rtl" name="sCountSendings" class="search">
											</td>
											<td class="td_admin_5" align="center" nowrap dir="ltr">
												<table cellspacing="0" cellpadding="0">
													<tr>
