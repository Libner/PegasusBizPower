...
Public Class adminRegistrationScreen
    ...
    Protected sReservationFromDate, sReservationToDate, sCountSendingsFrom, sCountSendingsTo, sLastSendingFromDate, sLastSendingToDate, sContactName As System.Web.UI.HtmlControls.HtmlInputText
    ...
    Protected FromCountSendings, ToCountSendings As String
    ...
    Public SendMailReservationFormPermitted As Boolean
...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        'permitions to send forms
        SendMailReservationFormPermitted = False
        ...
        End If
        If Request.Cookies("bizpegasus")("SendMailReservationForm") = "1" Then
            SendMailReservationFormPermitted = True
        End If
        'Response.Write(SendMailReservationFormPermitted)
    ...
    Sub btnSearchAll_onClick(ByVal s As Object, ByVal e As EventArgs) Handles btnSearchAll.Click
        ...
        sCountSendingsFrom.Value = ""
        sCountSendingsTo.Value = ""
    ...
    Sub setSearchFields()
        ...
        If func.dbNullFix(Request("sCountSendingsFrom")) <> "" Then
            queryParamSearch = queryParamSearch & "&sCountSendingsFrom=" & Request("sCountSendingsFrom")
        End If
        If func.dbNullFix(Request("sCountSendingsTo")) <> "" Then
            queryParamSearch = queryParamSearch & "&sCountSendingsTo=" & Request("sCountSendingsTo")
        End If
    End Sub
    Public Sub bindList()
        ...
        cmdSelect.Parameters.Add("@countSendingsFrom", SqlDbType.VarChar, 20).Value = sCountSendingsFrom.Value
        cmdSelect.Parameters.Add("@countSendingsTo", SqlDbType.VarChar, 20).Value = sCountSendingsTo.Value
