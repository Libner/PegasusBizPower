...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        PEdit = Request.Cookies("bizpegasus")("salesControlEdit") 'Request.QueryString("PEdit")
    ...
    Sub TableSales()
        ...
        Dim cmdSelect As New SqlClient.SqlCommand("SET DATEFORMAT dmy;select IsNull(TimeZmanSales,0) as TimeZmanSales,IsNull(ProcSalesCallMerkaz,0) as ProcSalesCallMerkaz,Dim_Month as SMonth ,DimYear as SYear from Departments_Data_Monthly WHERE  (DimYear <= " & currYear & " and DimYear>=" & currYear - 2 & ") and Dim_Month=" & currMonth & " And departmentId = " & dep & " order by DimYear desc", con)
        cmdSelect.CommandType = CommandType.Text
        con.Open()
    ...
    Sub TableService()
        ...
        Dim cmdSelect As New SqlClient.SqlCommand("SET DATEFORMAT dmy;select IsNull(Avrg_Call,0) as Avrg_Call,IsNull(Avrg_CallProc,0) as Avrg_CallProc,Dim_Month as SMonth ,DimYear as SYear from Departments_Data_Monthly WHERE  (DimYear <= " & currYear & " and DimYear>=" & currYear - 2 & ") and Dim_Month=" & currMonth & " And departmentId = " & dep & " order by DimYear desc", con)
        cmdSelect.CommandType = CommandType.Text
        con.Open()
    ...
    Sub MonthData()
        ...
        " isNull(P16724ContactUs_Sales,0) as P16724ContactUs_Sales,IsNull(P16724ContactUs_Service,0) as P16724ContactUs_Service,IsNull(P17012ContactUs_Sales,0) as  P17012ContactUs_Sales,IsNull(P16735,0) as P16735," & _
        " IsNull(P16735_Bitulim,0) as P16735_Bitulim, IsNull(P17012ContactUs_Service,0) as  P17012ContactUs_Service,IsNull(P16504,0) as P16504, IsNull(DD.call_Service,0) as call_Service,IsNull(DD.call_Sales,0) as call_Sales, CalendarYear, " & _
        " CalendarDay , HolidayName, DayFontColor, WeekdayNumber, WeekdayNameHeb, DayTypeName, DayTypeColor, IsHoliday FROM DimDate A  left join Departments_Data DD on DD.DateKey=A.DateKey " & _
