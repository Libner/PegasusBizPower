...
jQuery("#frameScrreen").hide();
}
else {
jQuery("#divIframeLoader").hide();
 jQuery("#frameScrreen").show();
 }
}
...
<img src="../../images/loading.gif" style="position:relative; top:12%; left:40%;" />
</div>

								<div style="position:relative;height:100%" >
									<div class="h_iframe" style="height:100%">
										<iframe name="frameScrreen" id="frameScrreen" src="SalesEfficiency.aspx?tab=<%=request.querystring("tab")%>&PEdit=<%=request.Cookies("bizpegasus")("salesControl_Edit")%>"	ALLOWTRANSPARENCY=true  marginwidth="0" marginheight="0" hspace="0" vspace="0"  frameborder="0" style="display: none;">
										</iframe>
									</div>
								</div>
