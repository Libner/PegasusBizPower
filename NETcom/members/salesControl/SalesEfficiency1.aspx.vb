...
Public Class SalesEfficiency1
    ...
    Protected WorkDays, SumVar1, SumVar16504, SumVar16470_40811_out, SumVar16470_40811_in, SumVar16735_40660, SumVar16735_40660Bitul As Integer
...
#End Region
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Dim cmdSelect = New SqlCommand("SET DATEFORMAT YMD;SELECT count(id) as WorkDays " & _
                ...
                "  AND DateDiff(d,DateKey, convert(smalldatetime,'" & pdateEnd & "',101)) >= 0  and  IsHoliday=0 and DayTypeId<>'0'", con)
    ...
    Sub GetData()
        ...
        Else
            ...
            Response.Write(dep & "--" & pdateStart & "--" & pdateEnd)
        End If
        '''  Response.Write("s=" & s & "<BR>")
