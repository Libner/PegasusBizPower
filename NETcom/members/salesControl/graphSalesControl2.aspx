<%@ Page Language="vb" AutoEventWireup="false" Codebehind="graphSalesControl2.aspx.vb" Inherits="bizpower_pegasus2018.graphSalesControl2"%>
<!DOCTYPE HTML>
<HTML>
	<HEAD>
	...
	<body>
		<center>
			<table cellpadding="0" cellspacing="0" border="0" width="100%">
				...
				<tr>
					<td align="center"><span style="FONT-SIZE:25px;COLOR:#1e9999">דוח יעד מול 
      ביצוע, רבעונים, שנת  <%=currentYear%></span></td>
				</tr>
			</table>
