<%@ Page Language="vb" AutoEventWireup="false" Codebehind="targetScreen.aspx.vb" Inherits="bizpower_pegasus2018.targetScreen"%>
...
//alert(pYear);
	...
	<DS:TOPIN id="topin" numOfLink="0"  numOfTab="108" toplevel2="112" runat="server"></DS:TOPIN>
...
<tr><td height=40 align=center valign=bottom>
									...
									<tr><td height=1 style="width:100%;background-color:#ffffff"></td></tr>
									<tr><td height=40 align=center><%#IIF (Container.DataItem("Sales")<>0 ,String.Format("{0:0.00}", (Container.DataItem("Sales_Point")/Container.DataItem("Sales"))*100),"")%>%</td></tr>
									<tr><td height=1 style="width:100%;background-color:#ffffff"></td></tr>
									<tr><td height=40 align=center><%#Container.DataItem("SalesYear")%></td></tr>
									<tr><td height=1 style="width:100%;background-color:#ffffff"></td></tr>
									<tr><td height=40 align=center><%#IIF (Container.DataItem("Sales")<>0 ,String.Format("{0:0.00}", (Container.DataItem("SalesYear")/Container.DataItem("Sales"))*100),"")%>%</td></tr>
									<tr><td height=1 style="width:100%;background-color:#ffffff"></td></tr>
									<tr><td height=40 align=center><%#func.dbNullFix(Container.DataItem("Kishuriot"))%>%</td></tr>
									...
									<tr><td height=1 style="width:100%;background-color:#ffffff"></td></tr>
										...
										<td align="center" valign=top width=6% ><table border=0 cellpadding=0 cellspacing=0 width=100%>
											<tr>
											<td align="center" valign=middle height=40 class="title_sort">מצטבר שנתי<td>
											</tr>
													<tr><td height=1 style="width:100%;background-color:#ffffff"></td></tr>
									...
									<tr><td height=1 style="width:100%;background-color:#ffffff"></td></tr>
									<tr><td height=40 align=center><%'=SumRow3%><%if SumSales>0 then%><%=String.Format("{0:0.00}",(SumSales_Point/SumSales)*100)%>%<%end if%></td></tr>
									<tr><td height=1 style="width:100%;background-color:#ffffff"></td></tr>
