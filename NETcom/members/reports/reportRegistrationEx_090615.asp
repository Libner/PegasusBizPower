...
<%  Session.LCID = 1037
 ...
 sql = "Exec dbo.get_AppealsCount16504_NotExists  @start_date='" & start_date & "', @end_date='" & end_date & "'," & _
   ...
   strXLS.Add	"<td class=xl25>סה``כ נרשמו</td></tr>"
	...
	strXLS.Add  "<tr><td class=xl25_blueRight colspan=7>בין התאריכים" &start_date & " - " & end_date &" <BR> נפתחו ל "& Ubound(arr_app,2)+1 &" היעדים</td><td class=xl25_blue>"& appealsCount16504All &"</td><td class=xl25_blue>"&sumCountryAll&"</td><td class=xl25_blue>"& round(cint(sumCountryAll)*100/cint(appealsCount16504All))&"%</td></tr>"
