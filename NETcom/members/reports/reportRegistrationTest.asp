...
<!-- start code -->
	...
	<TR>
		...
		<TR>
			<TD align=center bgcolor="#DBDBDB" colspan=2><A class="but_menu" href="#" onclick="report_open('reportRegistrationEx.asp');" style="width:250"><span id="word12" name=word12>EXCEL דוח</span></a></TD>
		</TR>						
		<TR>						
			<TD align=center bgcolor="#DBDBDB" colspan=2><A class="but_menu" href="#" onclick="report_open('reportRegistrationGraph.aspx');" style="width:250"><span id="word13" name=word13>דוח גרפי</span></a></TD>
		</TR>
		<TR>						
			<TD align=center bgcolor="#DBDBDB" colspan=2><A class="but_menu" href="#" onclick="report_open('reportRegistrationGraph2.asp');" style="width:250"><span id="word14" name=word14>גרף התפלגות</span></a></TD>
		</TR>
			<%end if%>
