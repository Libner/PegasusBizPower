...
<!-- start code -->
	...
	<TR>
		...
		<%if false then%><TR>						
			<TD align=center bgcolor="#DBDBDB" colspan=2><A class="but_menu" href="#" onclick="report_open('reportRegistrationGraph.asp');" style="width:250"><span id="word13" name=word13>דוח גרפי</span></a></TD>
		</TR>	<%end if%>
	</TABLE>			
</FORM>
  <!-- End main content -->
