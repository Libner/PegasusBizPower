...
'response.Write "countryid-="&countryid   
   	...
   	sql = "Exec dbo.get_reportRegistrationYears  @start_date='" & start_date & "', @end_date='" & end_date & "'," & _
	"@start_date1='" & DateAdd("yyyy",-1,start_date)& "', @start_date2='" & DateAdd("yyyy",-2,start_date)& "'," & _
	"@end_date1='" & DateAdd("yyyy",-1,end_date)& "', @end_date2='" & DateAdd("yyyy",-2,end_date)& "'," & _
...
'Response.Write sql
	...
	CountAll=trim(arr_app(2,aa))
	CountAll1=arr_app(3,aa)
	CountAll2=arr_app(4,aa)
  ...
  strXLS.Add  "<td class=xl25_red  x:str>" : strXLS.Add  calculateappealsCount : strXLS.Add "%</td>"
	...
	strXLS.Add  "<td class=xl25_white  x:str>": strXLS.Add pSum1: strXLS.Add "% ( " :  strXLS.Add CountAll1 :  strXLS.Add " )</td>"
		...
		'		strXLS.Add  "<td class=xl25_blue  x:str>pSum1-": strXLS.Add pSum1: strXLS.Add"</td><td class=xl25_blue  x:str>pSum-": strXLS.Add pSum:strXLS.Add "-":strXLS.Add CountAll:strXLS.Add "-":strXLS.Add appealsCount16504: strXLS.Add"</td></tr>"
