...
<%Function enterFix(word)
	...
	For aa=0 To Ubound(arr_app,2)
		...
		'strXLS.Add "<td class=xl26 x:str>"  : strXLS.Add contact_desc  : strXLS.Add "</td>
		strXLS.Add "<td class=xl26 x:str>"  : strXLS.Add contact_responsible  : strXLS.Add "</td>"
		'<td class=xl26 x:str>"  : strXLS.Add enterFix(user)  : strXLS.Add "</td>"
			If trim(quest_id) = "16504" Then
