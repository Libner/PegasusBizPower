...
<%
	type_reports = trim(Request("type"))
	 numOftab = 1
     numOfLink =  7
	topLevel2 = 77 'current bar ID in top submenu - added 03/10/2019
...
<!-- start code -->
	...
	<tr>
			...
			<option value="" >----------------------------- בחר טופס -----------------------------</option>
					...
					<option value="16735">טופס רישום חתום</option>
			    	<option value="16504">טופס מתעניין בטיול</option>
			</select>
			</td>
		...
		<TR>
			<TD align=center bgcolor="#DBDBDB" colspan=2><A class="but_menu" href="#" onclick="report_open('reportLoyaltyEx.asp');" style="width:250"><span id="word12" name=word12>EXCEL דוח</span></a></TD>
		</TR>						
