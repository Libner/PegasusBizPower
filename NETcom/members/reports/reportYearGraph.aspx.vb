...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Do While drCountry.Read()
            ...
            pquest_id = 16504
            Dim sql = "Exec dbo.get_AppealsCount16504  @start_date='" & dateStart & "', @end_date='" & dateEnd & "'," & _
        " @countryID=" & func.sFix(pcountryid) & ", @productID=" & func.sFix(pquest_id)
            ...
            Dim sqlL = "Exec dbo.get_AppealsCount16504  @start_date='" & DateAdd("yyyy", -1, dateStart) & "', @end_date='" & DateAdd("yyyy", -1, dateEnd) & "'," & _
           " @countryID=" & func.sFix(pcountryid) & ", @productID=" & func.sFix(pquest_id)
            ...
            Dim sql2 = "Exec dbo.get_AppealsCount16504  @start_date='" & DateAdd("yyyy", -2, dateStart) & "', @end_date='" & DateAdd("yyyy", -2, dateEnd) & "'," & _
           " @countryID=" & func.sFix(pcountryid) & ", @productID=" & func.sFix(pquest_id)
