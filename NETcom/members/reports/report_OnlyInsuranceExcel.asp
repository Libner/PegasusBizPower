...
'  response.end
    ...
    strXLS.Add  "<tr style='background:#808080;color:#ffffff'><td colspan=7 class=xl24 style='background:#808080;color:#ffffff'> דוח ביטוחים שנשלחו</td></tr>"
...
sumInsYes=0
sumInsNo=0
	sql = "Exec dbo.get_OnlyInsurance_reportExcel  @start_date='" & start_date & "', @end_date='" & end_date &"'"
	'Response.Write sql
	'Response.End
