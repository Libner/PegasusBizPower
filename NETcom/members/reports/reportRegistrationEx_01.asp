...
<%  Session.LCID = 1037
   ...
   Dim strXLS
    ...
    strXLS.Add  "<tr style='background:#808080;color:#ffffff'><td colspan=9 class=xl24 style='background:#808080;color:#ffffff'>דוח מעקב רישום</td></tr>"

    strXLS.Add  "<tr style='background:#808080;color:#ffffff'><td colspan=9 class=xl24 style='background:#808080;color:#ffffff'> " & start_date & " - " & end_date & " טפסי רישום שנפתחו בין תאריכים </td></tr>"
    strXLS.Add	"<tr><td class=xl25></td><td class=xl24 colspan=7>ימים מפתיחת טופס מתענ``ן עד ההרשמה </td><td class=xl25></td></tr>"
    strXLS.Add	"<tr><td class=xl25>סה``כ נרשמו</td><td class=xl25>61-90 ימים</td><td class=xl25>31-60 ימים</td><td class=xl25>22-30 ימים</td><td class=xl25>15-21 ימים</td><td class=xl25>8-14 ימים</td><td class=xl25>3-7 ימים</td><td class=xl25>0-2 ימים</td><td class=xl25></td></tr>"
   

   
   
   	sql = "Exec dbo.get_reportRegistration  @start_date='" & start_date & "', @end_date='" & end_date & "'," & _
	" @countryID=" & nFix(countryid) & ", @productID=" & nFix(quest_id) 
	'Response.Write sql
	'Response.End
 ...
 sql = "Exec dbo.get_AppealsCount16504_NotExists  @start_date='" & start_date & "', @end_date='" & end_date & "'," & _
	...
	set rs_count = nothing
		...
		sumCountry=	Cint(count02) +Cint(count3_7) +Cint(count8_14)+Cint(count15_21)+Cint(count22_30)+Cint(count31_60)+Cint(count61_90)
		...
		pcount61_90=Round(100*Cint(count61_90)/Cint(sumCountry))
			...
			strXLS.Add  "<tr><td class=xl26  x:str>" : strXLS.Add sumCountry : strXLS.Add"</td>"
		...
		strXLS.Add  "<td class=xl26 x:str>" : strXLS.Add count02  : strXLS.Add "</td><td class=xl24 x:str>"  : strXLS.Add countryName :strXLS.Add "</td></tr>"
	

		strXLS.Add  "<tr><td class=xl26_yellow  x:str></td>"
		...
		strXLS.Add  "<td class=xl26_yellow x:str>" : strXLS.Add pcount02  : strXLS.Add "%</td><td class=xl26_yellow x:str>אחוז מסך הכל נרשמים</td></tr>"
	
	
		strXLS.Add  "<tr><td class=xl25_blue  x:str>כמות טפסים מתעניין ללא טופס רישום בסטטוס מעקב</td>"
		...
		strXLS.Add  "<td class=xl25_blueRight colspan=4 x:str>נפתחו ל" : strXLS.Add countryName : strXLS.Add"</td></tr>"
	...
	if appealsCount16504>0 then
		...
		strXLS.Add  "<TR><td class=xl25_blue  x:str>" : strXLS.Add appealsCountNotExist_Track16504: strXLS.Add "</td>"
		...
		strXLS.Add  "<td class=xl25_blue colspan=4 x:str></td></tr>"
		strXLS.Add  "<tr><td style='background:#92D050 ;height:6px' colspan=9></td></tr>"
		strXLS.Add  "<tr><td class=xl26 colspan=9></td></tr>"
		strXLS.Add  "<tr><td class=xl26 colspan=9></td></tr>"
