...
<tr>
<td nowrap align="center"><a class="button_edit_1" style="width:80;" href="taskDetailsAll.asp?pUserId=<%=pUserId%>">&nbsp;נקה&nbsp;</a></td>

<td nowrap align="center"><a class="button_edit_1" style="width:80;" href="#" onclick="document.form_search.submit();">&nbsp;<!--עדכן תאריך-->חפש&nbsp;</a></td>
...
<td  align="<%=align_var%>" nowrap>תוכן סגירה</td>
...
<td  align="<%=align_var%>" nowrap >תוכן משימה</td>
...
<td  align="<%=align_var%>" >&nbsp;<!--עד תאריך--><%=arrTitles(13)%>&nbsp;</td>
...
</td><td align="<%=align_var%>" ><!--מתאריך--><%=arrTitles(12)%></td>
<td>
