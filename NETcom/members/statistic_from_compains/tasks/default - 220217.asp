...
<TD align=right><input type="text" name="contentMess" id="contentMess" value="<%=contentMess%>"  class="search" style="width: 160px;" dir="rtl"></TD>
<td width=80>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>

<TD align=right><input type="text" name="contentClose" id="contentClose" value="<%=contentClose%>"  class="search"  style="width: 160px;" dir="rtl"></TD>
<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>

<td align="left"><a class="button_edit_1" style="width:80;" href="#" onclick="document.form_searchTop.submit();">&nbsp;<!--עדכן תאריך-->חיפוש&nbsp;</a></td>

<td align="left" width="30" valign="bottom"><a href="#" onclick="javascript:ClearAllS();" class="button_edit_1" style="width:50px">&nbsp;הכל&nbsp;</a></td>
...
<tr>
	<td align="center" colspan=2 nowrap>
		<a href='' onclick='callCalendar(document.form_search.start_date,"Asstart_date");return false;' id='Asstart_date'>
...
<TR>
	<td align="center" colspan=2 nowrap>
			<a href='' onclick='callCalendar(document.form_search.end_date,"Asend_date");return false;' id="Asend_date">
