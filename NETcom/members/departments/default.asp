...
<tr>
	...
	<td width="80" nowrap align="center" class="title_sort">&nbsp;<span id="Span1" name=word4>רמת עדיפות</span>&nbsp;</td>	
	
	<td width="100%" align="<%=align_var%>" class="title_sort">&nbsp;<span id="word5" name=word5>שם מחלקה</span>&nbsp;</td>	
</tr>
...
<tr><td nowrap colspan=2 align="center"><a class="button_edit_1" style="width:100;"  href='#' OnClick="return openDepartments('')"><span id=word6 name=word6><!--הוספת קבוצה-->הוספת מחלקה</span></a></td></tr>
