...
<%Response.Buffer = False
  ...
  UserID = cInt(trim(trim(Request.Cookies("bizpegasus")("UserID"))))
...
<%	
    If trim(groupId) <> ""  Then
	   ...
	   sqlstr = "Exec dbo.get_contacts_address '" & types_id & "','" & OrgID & "','" & groupId & "'"
	   'Response.Write sqlstr
	   'Response.End
	   con.executeQuery(sqlstr)
	   strUrl = "group1.asp?groupId=" & groupId%>    
   <script language=javascript>
	<!--
...
<form name="form1" id="form1" target="_self" ACTION="getContacts1.asp?groupId=<%=groupId%>&add=1" METHOD="post">
<tr>
	<td align=right>
