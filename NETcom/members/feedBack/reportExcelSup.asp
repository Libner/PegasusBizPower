...
<% Response.CharSet = "windows-1255"
 ...
 'Next
 'response.end
 BizpowerDBName="bizpower_pegasus"
	%>
...
strXLS.Add  "</tr>"
	sql = "Exec dbo.[GetScreenFeedbackExcel_Supp]  '"& FromDate & "','"& ToDate & "','"& FromGrade & "','"& ToGrade & "','"& ser_id & "','"& guide_id & "','"& dep_Code  &"','" & SupplierId &"','"& BizpowerDBName &"'"
'response.Write sql
'response.end
