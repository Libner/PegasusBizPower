...
<tr>
	...
	<textarea id="SMS_content" name="SMS_content" dir="<%=dir_obj_var%>" onkeyup="textLimit(this, <%=smsText%>);" style="height:100;width:250;line-height:120%;" class="Form" ><%=SMS_content%></textarea>
	</td>	
