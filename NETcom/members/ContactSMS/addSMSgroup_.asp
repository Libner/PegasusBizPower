...
'send  sms
	...
	smsStatusId="0"
		sqlstr = "Select appeals.Company_Id,appeals.Contact_Id,cellular from appeals left join Contacts on appeals.Contact_id=contacts.Contact_Id WHERE appeal_id IN (" & appealsId & ")"
...
<tr>
	...
	style="width:100;background-color:#c0c0c0;color:#808080"" id="sms_phone" name="sms_phone" value="0500000000" maxlength="10" readonly></td>
