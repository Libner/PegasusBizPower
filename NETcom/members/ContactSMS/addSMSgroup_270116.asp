...
<tr>
	...
	<textarea dir="<%=dir_obj_var%>" type="text" class="texts" style="width:250" id="SMS_content" name="SMS_content" <%if Request.Cookies("bizpegasus")("Sms_Write")="0" then%> readonly <%end if%>
	value="<%=vFix(smstext)%>" MaxLength="126" onkeyup="return checkLen(this, 70, 1, 1);" onchange="return checkLen(this, 70, 1, 1);"><%=SMS_content%></textarea>
	</td>	
