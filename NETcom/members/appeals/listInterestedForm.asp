...
<tr>
	<td align="<%=align_var%>" class="page_title" width="100%" style="border-left: none">&nbsp;&nbsp;טפסי מתעניין לטיול שנפתחו ב-6 חודשים אחרונים<%'=Country_Name%></td>
</tr>
</table>
</td></tr>
<TR>
