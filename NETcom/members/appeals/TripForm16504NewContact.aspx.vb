...
Public Class TripForm16504NewContact
...
#End Region
    ...
    Private Sub SaveData()
        ...
        If IsNumeric(contactID) And Len(contactName) > 0 Then
        ...
        Else
            ...
            Dim sqlCheck = New SqlClient.SqlCommand("EXEC dbo.contacts_chk_phone	@OrgId='" & OrgID & "', @EditContactId='" & contactID & "', " & _
        ...
        ' Response.Write("contactID=" & contactID & "<BR>")s
        ' Response.Write("contactName=" & contactName & "<BR>")
        '  Response.End()
