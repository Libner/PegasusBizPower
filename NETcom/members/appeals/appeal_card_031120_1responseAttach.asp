...
%>
    ...
    sqlstr = "Select response_content ,response_date ,response_email, sender_name,response_subject,response_attFile,response_sendGroup From appeal_responses_view " &_
    ...
    do while (not responsesList.eof and j<responsesList.PageSize)   
		...
		response_sendGroup= responsesList.Fields(6)
                                                        %>
															<tr>
																<td align="center" dir="<%=dir_obj_var%>" class="card" style="padding-right: 5px; padding-left: 5px" valign="middle"><%if trim(response_attFile)<>"" then%><a href="../../../download/send_attachments/<%=response_attFile%>" target="_blank"><img src="../../images/MsgAttachment.gif" border="0"></a><%end if%></td>
