<%@ Page Language="vb" AutoEventWireup="false" Codebehind="TripForm16504NewContact.aspx.vb" Inherits="bizpower_pegasus2018.TripForm16504NewContact"%>
...
<script>
  ...
  <body>
	...
	<tr>
		...
		<tr><td  align="right"><input type=text dir="rtl" name="contact_name" id="contact_name" value="<%=contactName%>" maxlength=50 style="width:200" class=Form onKeyUp="refreshContactsPr(this,'16504')" onKeyDown="refreshContactsPr(this,'16504')"  ></td>
		<td align="right" nowrap class="form_title" valign=top>					
			&nbsp;<b>שם מלא</b>&nbsp;<font style="color:#FF0000;font-size:12px">*</font></td>
		</tr> 			    
	
		<tr><td  align="right"><input type=text dir="ltr" name="phone" value="" maxlength="20" value="<%=contactPhone%>" style="width:100" class="Form" ID="phone">  </td>
		<td align="right" nowrap class="form_title" valign=top>					
			&nbsp;<b>טלפון</b>&nbsp;</td>
		</tr>
		<tr><td  align="right"><input type=text dir="ltr" name="cellular" value="<%=contactCellular%>" style="width:100" maxlength=20 class="Form" ID="cellular">    </td>
		<td align="right" nowrap class="form_title" valign=top>					
			&nbsp;<b>טלפון נייד</b>&nbsp;</td>
		</tr>
		<tr><td  align="right"><input type=text name="email" dir=ltr value="<%=contactEmail%>" style="width:200" maxlength=50 class="Form" ID="email">     </td>
		<td align="right" nowrap class="form_title" valign=top>					
			&nbsp;<b>Email</b>&nbsp;</td>
		</tr> 		 			 			    
