...
<%
  ...
  <table cellpadding="2" cellspacing="0" border="0" >
	<tr>
	<td align="center" ><a class="button_edit_1" style="width:90px; line-height:110%; padding:5px"  href='javascript:void(0)' onclick="if (checktransf()) {document.getElementById('form1').submit()}">העברה לארכיון</a></td>
