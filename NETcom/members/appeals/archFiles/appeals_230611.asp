...
<%if Request("Page")<>"" then
	...
	<tr style="background-color: #8A8A8A">
		...
		<td width="95"  nowrap align="<%=align_var%>" dir="<%=dir_obj_var%>"><input type="text" class="search" dir="<%=dir_obj_var%>" style="width:90px;" value="<%=vFix(usname)%>" name="usname" ID="usname" maxlength="50"></td>	
