...
<td align="center" dir="<%=dir_obj_var%>" width="100%">   
     <SELECT dir="<%=dir_obj_var%>" size=1 ID=Tour_id name=Tour_id class="sel" style="width:310px;font-size:10pt"   <%if quest_id = 16735 then %>onchange="selectToursDateNew(this)"<%else%>onchange="selectToursDate(this)"<%end  if%>">	
<%If trim(lang_id) = "1" Then%>
