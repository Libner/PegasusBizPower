...
<html>
	...
	if appID = nil and quest_id <> nil then	   
		...
		" QUESTIONS_ID, appeal_status, appeal_deleted, type_id, User_Id_Order_Owner, ORGANIZATION_ID,appeal_CountryId,RelationId) " & _
		" VALUES ('" & appeal_date & "'," & UserID & "," & contactID & "," & companyID & "," & projectID & "," &_
		mechanismID & "," & quest_id & ",'" & appeal_status & "',0,2," & UserIdOrderOwner & "," & OrgID  & "," & CRM_Country &","& RelationId &");"&_
		"SELECT @@IDENTITY AS NewID"
 ...
 End If	
	elseif appID <> nil and quest_id <> nil then	        
	    ...
	    ", MECHANISM_ID = " & mechanismID & ", User_Id_Update = " & UserId & ", User_Id_Order_Owner = " & UserIdOrderOwner & _
