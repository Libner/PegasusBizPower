...
<!--
	function fncChk()
	{
			...
			if(strid != "")
			{
				...
				if (fl && confirm("? האם ברצונך לסגור את הטפסים המסומנים")){
...
<%
  ...
  <tr>  
  <td class="title_form"><input type="button" value="סגור טפסים מסומנים" class="button_edit_2" style="width: 130px"
   onclick="if (fncChk()) {document.form1.submit()}" ></td>
  <td class="title_form" width="100%" align="<%=align_var%>" dir=<%=dir_obj_var%>>&nbsp;<!--טפסים מצורפים--><%=arrTitles(28)%>&nbsp;<font color="#E6E6E6">(<%=contactName%>)</font>&nbsp;</td>
  </tr>
  </table></td></tr>  	  	
  <tr>
