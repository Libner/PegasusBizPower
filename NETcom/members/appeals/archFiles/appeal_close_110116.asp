...
<tr>
	...
	<input type=image src='../../images/calend.gif' onclick='return popupcal(this.form.elements("closeDate"));'>&nbsp;<input dir="ltr" type="text" class="passw" style="width:70" id="closeDate" name="closeDate" value="<%=closeDate%>" maxlength=10 onclick="return popupcal(this);" readonly>
	</td>
