Public Class ChangesNewsLetters
...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        date_start = Trim(Request.QueryString("date_startNewsL"))
        date_end = Trim(Request.QueryString("date_endNewsL"))
        ...
        XLSfile.Append("<tr><td colspan='11' class='xl24'>דוח לוגים על שינוי שדה מעוניין בקבלת דיוור</td></tr>")
        ...
        XLSfile.Append("<tr style='mso-height-source:userset;height:28.5pt'><td class=xl25>איש קשר</td>")
        XLSfile.Append("<td class=xl25>תוכן שדה</td><td class=xl25>תאריך שינוי</td><td class=xl25>שם משתמש</td><td class=xl25>כתובת IP</td></tr>") : XLSfile.Append(vbCrLf)

        Dim con As New SqlClient.SqlConnection(ConfigurationSettings.AppSettings.Item("ConnectionString"))
        Dim cmdSelect As New SqlClient.SqlCommand("get_report_changes_NewsLetters", con)
        ...
        If dtTmp.Rows.Count > 0 Then
            For pp As Integer = 0 To dtTmp.Rows.Count - 1
                ...
                XLSfile.Append("<tr><td class=xl26 x:str>") : XLSfile.Append(Trim(dtTmp.Rows(pp)("Object_Title"))) : XLSfile.Append("</td>")
                ...
                XLSfile.Append("<td class=xl26 x:str>") : XLSfile.Append(Trim(dtTmp.Rows(pp)("NewsLetter_Value"))) : XLSfile.Append("</td>")
            ...
            Next
               End If
                ...
                Dim filestring As String = "changesNewsLetters_" & CStr(Now.Hour) & "_" & CStr(Now.Minute) & "_" & CStr(Now.Second) & ".xls"
