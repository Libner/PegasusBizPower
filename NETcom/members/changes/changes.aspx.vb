...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        date_start = Trim(Request.QueryString("date_start"))
        date_end = Trim(Request.QueryString("date_end"))

        ChangeType = Trim(Request.QueryString("cmbChangeType"))
        ChangeTable = Trim(Request.QueryString("cmbChangeTable"))
        ...
        XLSfile.Append("<tr><td colspan='7' class='xl24'>דוח לוגים</td></tr>")
        XLSfile.Append("<tr><td colspan='7' class='xl24'>") : XLSfile.Append(date_start) : XLSfile.Append(" - ") : XLSfile.Append(date_end) : XLSfile.Append("</td></tr>")
        If Len(ChangeType) > 0 Then
            XLSfile.Append("<tr><td colspan='7' class='xl24'>סוג פעילות: ") : XLSfile.Append(ChangeType) : XLSfile.Append("</td></tr>")
        End If
        If Len(ChangeTable) > 0 Then
            XLSfile.Append("<tr><td colspan='7' class='xl24'>סוג אובייקט: ") : XLSfile.Append(ChangeTable) : XLSfile.Append("</td></tr>")
        End If
        XLSfile.Append("<tr><td colspan='7' class='xl24'> ")
        ...
        XLSfile.Append("<tr style='mso-height-source:userset;height:28.5pt'><td class=xl25>אובייקט</td><td class=xl25>אובייקט שם</td>")
        XLSfile.Append("<td class=xl25>סוג שינוי</td><td class=xl25>תאריך שינוי</td><td class=xl25>שם משתמש</td><td class=xl25>כתובת IP</td></tr>") : XLSfile.Append(vbCrLf)

        Dim con As New SqlClient.SqlConnection(ConfigurationSettings.AppSettings.Item("ConnectionString"))
        Dim cmdSelect As New SqlClient.SqlCommand("get_report_changes", con)
        ...
        End If
        cmdSelect.Parameters.Add("@ChangeType", Trim(ChangeType))
        ...
        If dtTmp.Rows.Count > 0 Then
            For pp As Integer = 0 To dtTmp.Rows.Count - 1
                ...
                XLSfile.Append("<td class=xl26 x:str>") : XLSfile.Append(Trim(dtTmp.Rows(pp)("Change_Type"))) : XLSfile.Append("</td>")
        ...
        Dim filestring As String = "changes_" & CStr(Now.Hour) & "_" & CStr(Now.Minute) & "_" & CStr(Now.Second) & ".xls"
