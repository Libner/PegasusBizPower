...
Public Class logScreenMembersLastEnter
    ...
    Protected sContactName, sPhone As System.Web.UI.HtmlControls.HtmlInputText

    Protected sEmail, sLastEnterFromDate, sLastEnterToDate, sCountEnters As String
...
#End Region
    ...
    Sub setSearchFields()
        ...
        If func.dbNullFix(Request.Form("sPhone")) <> "" Then
            sPhone.Value = Request.Form("sPhone")
        ElseIf func.dbNullFix(Request.QueryString("sPhone")) <> "" Then
            sPhone.Value = Request.QueryString("sPhone")
        Else
            sPhone.Value = ""
        End If
    ...
    Public Sub bindList()
        ...
        cmdSelect = New SqlCommand("get_LogContactsLastEntersTours", con)
