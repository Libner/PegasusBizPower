...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        XLSfile.Append("    <x:Name>דוח הזמנות לנציג</x:Name>")
        ...
        XLSfile.Append("<tr><td colspan=5 class=xl24>דוח הזמנות לנציג: " & UserName & "</td></tr>")
        ...
        cmdSelect = New SqlClient.SqlCommand("SELECT Appeal_Id as [מספר טופס], Appeal_Date as [תאריך], TourNum as [קוד הטיול], Docket as [מספר דוקט], " & _
        " CountPeople as [כמות האנשים], CASE isNULL(Appeal_Id_G, 0) WHEN 0 THEN 'לא' ELSE 'כן' END [הוזן תקין], " & _
        ...
        While dr.Read()
            ...
            For i As Integer = 0 To dr.FieldCount - 1
                ...
                XLSfile.Append("<td ")
                If ((Val = "לא" And i = dr.FieldCount - 2) Or (Val <> "תקין" And i = dr.FieldCount - 1)) Then
