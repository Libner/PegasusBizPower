...
<%If trim(T) = "OUT" Then%>
<td align="right">
<select name="reciver_id" dir="<%=dir_obj_var%>" class="norm" style="width:100%" ID="reciver_id" onChange="form_searchTop.submit();">
...
<%If trim(T) = "IN" Then%>
<td align="right" >
<select name="sender_id" dir="<%=dir_obj_var%>" class="norm"  ID="sender_id" onChange="form_search.submit();">
