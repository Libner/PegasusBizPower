...
'	response.Write "appDepId="&appDepId 
	...
	appDepId=0
				...
				<%numOfTab = 5%>
				<%numOfLink = 0%>
				<%topLevel2 = 60 'current bar ID in top submenu - added 03/10/2019%>
				<tr>
					<td width="100%">
				...
				<tr>
					<td class="page_title" colspan="2">&nbsp;</td>
				</tr>
				<tr>
				...
				<tr>
					<td width="100%" align="center" valign="top">
						<table border="0" cellspacing="1" width="100%" align="center" cellpadding="0" dir="ltr"
							ID="Table2">
							<tr>
								<td>
									<table border="0" cellspacing="1" width="60%" align="center" cellpadding="0" dir="rtl">
										<tr>
											<th width="70%" align="<%=align_var%>" class="form_title" dir="<%=dir_obj_var%>" rowspan=2>
												&nbsp;ריכוז משימות:&nbsp;</th>
											<th class="textp" align="center" rowspan="2" width="30%">
												מחלקה</th>
										...
										<tr>
											<th width=70 nowrap align="center" class="textp" dir="<%=dir_obj_var%>">
												חדש</th>
											<th width=70 nowrap align="center" class="textp" dir="<%=dir_obj_var%>">
												בטיפול</th>
											<th width=70 nowrap align="center" class="textp" dir="<%=dir_obj_var%>">
...
''	Response.Write sqlstr
	...
	%>
										<tr height="24" bgcolor="#e6e6e6" onmouseover="this.style.backgroundColor='#B1B0CF';"
											onmouseout="this.style.backgroundColor='#E6E6E6';" style="background-color: rgb(230, 230, 230);">
...
%>
								...
								<td width="110" nowrap valign="top" class="td_menu">
									<table cellpadding="1" cellspacing="1" width="100%" ID="Table3">
										...
										<tr>
											<td colspan="2">
												<select name="app_DepId" id="app_DepId" dir="rtl" class="norm" style="width: 120px;height:200px"
													multiple>
										...
										<TR>
											<td colspan="2" align="center">
												<a class="button_edit_1" style="width:90px; line-height:110%; padding:3px" href="javascript:void(0)"
													onclick="javascript:SendData()">הצג</a>
											</td>
										</TR>
									</table>
								</td>
