...
<table border="0" width="100%" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <table width="100%" cellspacing="1" cellpadding="1" border=0 bgcolor="#ffffff" >
		...
		<tr>
		<td><input type="text" class="search" dir="rtl" style="width:98;" value="<%=vFix(search_docket)%>" name="search_docket" ID="search_docket" onkeypress="return entsubsearchg(event);" >
...
<%
if sFix(search_contact)<>"" or sFix(search_email)<>"" or sFix(search_company)<>"" or sFix(search_city_Name)<>"" or sFix(search_messanger_name) <>""  or sFix(search_docket) <>""  or  sFix(search_phone)<>"" or sFix(search_cellular)<>"" or  contact_type>0 then
sqlSelect = "Exec dbo.get_company_contacts @Page=" & Page & ", @RecsPerPage=" & PageSize & ", @OrgID=" & OrgID & _
	...
	"', @cellular = '" & sFix(search_cellular) & "', @sort='" & sortby(sort) & "', @show_only_double=" & show_only_double & ", @docket='" & sFix(search_docket)  &"'"
