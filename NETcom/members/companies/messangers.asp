...
<!--
	...
	{	 
		...
		If trim(lang_id) = "1" Then
			str_confirm = "?האם ברצונך למחוק את העיסוק"
		Else
...
<tr>
	...
	<td width="100%" align="<%=align_var%>" class="title_sort">&nbsp;<span id="word5" name=word5><!--עיסוק--><%=arrTitles(5)%></span>&nbsp;</td>	
</tr>
...
%>
<tr>
	<td align="center" bgcolor="#e6e6e6" nowrap><a href="messangers.asp?deleteId=<%=item_id%>" ONCLICK="return checkDelete()"><IMG SRC="../../images/delete_icon.gif" BORDER=0 alt="מחיקת עיסוק"></a></td>
...
<tr><td nowrap colspan=2 align="center"><a class="button_edit_1" style="width:100;"  href='#' OnClick="return openmessanger('')"><span id=word6 name=word6><!--הוספת עיסוק--><%=arrTitles(6)%></span></a></td></tr>
<tr><td nowrap colspan=2 align="center"><a class="button_edit_1" style="width:100;"  href="excel_messangers.asp" target=_blank><!--הצג דוח--><%=arrTitles(7)%></a></td></tr>
