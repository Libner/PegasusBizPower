...
<tr><td><%If false then%><iframe id=checkMess src="http://bluto/bizpower_pegasus/NETcom/members/messages/checkNewMessagesWindow.aspx" frameborder="0" height="0" width="0"></iframe><%'end if%></td></tr>
    <%end  if%>
    <tr>
