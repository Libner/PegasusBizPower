Public Class topInclude
    ...
    Dim sql_obj, sqlstr, parent_id, parent_order, strLocal, userId, orgID, lang_id, barID, barTitle, _
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ' Response.Write("user=" & Request.Cookies("bizpegasus")("UserId"))
        'Response.Write("numOfLink=" & numOfLink)
        ' Response.Write("numOfTab=" & numOfLink)
        ...
        While rs_obj.Read()
            ...
            arr_bars(3, bar_count) = func.dbNullFix(rs_obj("parent_id"))
            arr_bars(4, bar_count) = func.dbNullFix(rs_obj("bar_url"))
            bar_count = bar_count + 1
            ReDim Preserve arr_bars(5, bar_count)
        End While
        'Response.Write("<br>get_user_bars: bar_title (1,1)" & arr_bars(1, 1))
        rs_obj.Close()
        ...
        For i = 0 To UBound(arr_bars_top, 2) - 1
            ...
            ' Response.Write("barId=" & barID & ":" & numOfTab & "<BR>")
        ...
        'Response.Write("<br>BarBottomPH: numOfTab=" & numOfTab & "<BR>")
        For j = 0 To UBound(arr_bars, 2) - 1
            ...
            'Response.Write(" barParent=" & barParent & " barVisible:" & barVisible & "<BR>")
