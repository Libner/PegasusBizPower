...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If Request.Form("username") <> "" Then
            ...
            " IsNULL(ORGANIZATIONS.FILE_UPLOAD, 0) as FILE_UPLOAD, IsNULL(USERS.EDIT_APPEAL, 0) as EDIT_APPEAL, IsNULL(USERS.ExportDataToExcel, 0) as ExportDataToExcel " & _
            ...
            If myReader.Read() Then
                ...
                Response.Cookies("bizpegasus")("UserName") = HttpUtility.UrlEncode(Trim(myReader("FIRSTNAME")) & " " & Trim(myReader("LASTNAME")), System.Text.Encoding.GetEncoding("utf-8"))
                ...
                Response.Cookies("bizpegasus")("ExportDataToExcel") = Trim(myReader("ExportDataToExcel"))
        ...
        sqlStr = "Select FIRSTNAME +' '+LASTNAME as name from USERS where User_Id=" & userId
        catCMD = New System.Data.SqlClient.SqlCommand(sqlStr, conn)
        conn.Open()
        rs_groups = catCMD.ExecuteReader(CommandBehavior.SingleRow)
        If rs_groups.Read() Then
            user_name = rs_groups("name")
        Else
            user_name = ""
        End If
        rs_groups = Nothing
