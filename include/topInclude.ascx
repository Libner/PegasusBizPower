<%@ Control Language="vb" AutoEventWireup="false" Codebehind="topInclude.ascx.vb" Inherits="bizpower_pegasus2018.topInclude" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
<table cellpadding="0" cellspacing="0" width="100%" border="0">
	...
	<tr>
		<td width="100%">
         ...
         <tr><td class="page_title">&nbsp;<!--אנא הקלד את שם החברה מימין או את שם איש הקשר לאיתור במאגר הלקוחות--></td></tr>
</table>
