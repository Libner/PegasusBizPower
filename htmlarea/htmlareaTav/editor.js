...
function editor_generate(objname,userConfig) {
  ...
  var tblOpenVersion  = '<table border=0 cellspacing=0 cellpadding=0 style="float: right;"  unselectable="on"><tr><td style="border: none; padding: 1 0 0 0"><nobr>';
