...
<%	pageid = Request.QueryString("pageid")
	...
	if formId <> "" then
		...
		con_image.open "FILE NAME="& server.MapPath("../../NETcom/netReply.udl")
	...
	if con.executeQuery(upEx) then
		if cbFormLink = "link" then
			htmlForm = "<IMG id=tofes src=../../../netCom/images/linkform_image.gif align=baseline border=0>"
		elseif cbFormLink = "form" then
			htmlForm = "<IMG id=tofes src=../../../netCom/images/form_image.gif align=baseline border=0>"
		else
			htmlForm = "<p align=" & fImgAlign & "><IMG id=tofes src=../../../netCom/GetImage.asp?DB=Page&FIELD=LINK_IMAGE&ID=" & pageid & "  border=0></p>"	
		end if	
	%> 
