...
strURL = "http://pegasus.bizpower.co.il/pegasus/SendCodebySMS_schedule.aspx"
...
If Err.Number <> 0 Then 'On Error Resume Next
        ...
        objMessage.Subject = "An Error UpdateSalesData16504.aspx"
        objMessage.TextBody = "An Error UpdateSalesData16504.aspx " & vbCrLf _
                & "Date: " & Now()
