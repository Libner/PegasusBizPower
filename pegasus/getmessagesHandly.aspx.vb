...
Public Class getmessagesHandly
    Inherits System.Web.UI.Page
    Protected fromDate, toDate As Date
    Dim fromMonth, fromDay, fromYear As Integer
...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Else
            If Request.QueryString("handly") = "1" Then
                Session.LCID = 1037
                'update entrance count
                Dim dateM As String
                ...
                startDate = New Date(fromDate.Year, fromDate.Month, fromDate.Day)
                endDate = New Date(toDate.Year, toDate.Month, toDate.Day)
