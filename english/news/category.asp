			...
			<tr>
				...
				<td align=right valign="top" width="100%">
						<table border="0" width="100%" cellpadding="0" cellspacing="0" ID="Table3">
							<tr>
								<td  align="right" width="100%" height="120" background="../images/home_pict_bgr.jpg"><img src="<%=Application("VirDir")%>/images/home_pict_right<%=Request.QueryString("catId")%>.jpg"></td>
							</tr>
																		...
																		<table align="right" border="0" width="100%" cellspacing="0" cellpadding="0" ID="Table10">       
																			...
																			<%'//start of news%>
																				<td align="right" style="padding-left:15px" width="100%" valign="top"> 
																					...
																					<%
																						sqlStr = "Select New_Id,New_Title,CONVERT(VARCHAR(8),New_Date,3) AS New_Date_Date from News where category_ID=2 AND New_Site_Visible=1 ORDER BY New_Date desc"
																						set rs_newsList=con.execute(sqlStr)
																						if rs_newsList.EOF then
																						%>
																						<tr>
																							<td width="100%" align="right" valign="top" class="head1">No announcement</td>
																						</tr>       
																						<%
																						end if
																						%>
																						...
																						%>
																							...
																							<tr>
																								<td width="100%" align="left" valign="top">
																									...
																									<tr><td align="left" class="headDate" style="color:#B53C52" valign="top"><%=New_Date_Date%></td></tr>
																									<tr><td align="left" valign="top" dir=rtl><a class="link_news" href="../news/news.asp?id=<%=New_ID%>"><u><%=New_Title%></u></a></td></tr> 
																									</table>
																								</td>
																							</tr>  
																							<tr><td height="5"></td></tr>																				
