...
<table bgcolor="#DDDDDD" cellpadding="0" cellspacing="0" border="0" dir="ltr">
	<tr>
	...
	'sqlStr = "SELECT Publication_Category_ID,Publication_Category_Name, Category_URL from Publication_Categories where  (Category_Vis = 1) AND Main_Category_ID = 2 order by Category_Order"
			...
			if not pag.eof then
				...
				if Page_Visible = "False" then
					...
					if not rs_parent_Pages.eof then
						str_parentId = "&parentId=" & rs_parent_Pages(0)
					else
						str_parentId = ""	
					end if
	...
	%>
		<td nowrap>
			<%if currPageId="-1" then%>
				&nbsp;&nbsp;&nbsp;<img src="images/shim.gif" width=0 height=3 border="0">&nbsp;&nbsp;<font color="#616D66">&#8226;</font>&nbsp;<a class="top_link"  href="<%=href_string%>" <%=onclick_string%> dir="rtl"><%=PubCategoryName%></a>		
			<%else%>
				&nbsp;&nbsp;&nbsp;<img src="images/shim.gif" width=0 height=3 border="0" name="menuLayer<%=i%>" alt="menuLayer<%=i%>">&nbsp;&nbsp;<font color="#616D66">&#8226;</font>&nbsp;<a class="top_link"  href="<%=href_string%>"  dir="rtl" onMouseOver="popUp('elMenu<%=i%>',event);status='';return true" onMouseOut="popDown('elMenu<%=i%>');status=''"><%=PubCategoryName%></a>
			<%i=i+1%>			
			<%end if%>
		</td>	
	<%
	...
	loop
     ...
     %>
		<td nowrap>
				&nbsp;&nbsp;&nbsp;<img src="images/shim.gif" width=0 height=3 border="0">&nbsp;&nbsp;<font color="#616D66">&#8226;</font>&nbsp;<a class="top_link"  href="<%=Application("VirDir")%>/default.asp" >עברית</a>			
		</td>	
