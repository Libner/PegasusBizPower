...
<%maincat=2%>
<!--#include file="../PopUpMenus/java_layer_home.asp"-->
  ...
  <table border="0" width="780" cellspacing="0" cellpadding="0" align=center>
    <tr>
      ...
      <table border="0" width="100%" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td><table border="0" width="201" cellspacing="0" cellpadding="0"  dir="ltr">
            <tr>
              <td width="100%" height="10"></td>
            </tr>
            <tr>
              <td width="100%">
			  <FORM style="margin-bottom: 0" method="POST" action="<%=Application("VirDir")%>/netCom/default.asp" name=form1 id=form1 onSubmit="return checkFields(this)">									
              <table border="0" width="201" cellspacing="0" cellpadding="0" dir="rtl">				
                <tr>
                  <td align="left" colspan=2><input type=hidden name="wizard_id" id="wizard_id" value="<%=Request("wizard_id")%>">
                 ...
                 <tr> 
                  ...
                  <input type="image" src="<%=Application("VirDir")%>/english/images/top_slah.gif" width="43" height="25" border="0" id=image1 name=image1 tabindex="-1">
                  </td>                 
                  <td align="left">
    ...
    <tr>
       ...
       <table border="0" width="100%"  cellspacing="0" cellpadding="0" valign="top" >
		...
		<!--#include file="../include/top_bar_links_home.asp"-->
		</td>
			<td width="100%" bgcolor="#DDDDDD" align="left" class="bar_top" valign="baseline" style="padding-left:35px;">
			...
			<marquee direction=left  scrolldelay=120>
				...
				%>
				&nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp;
				<a class="homeNews" href="news/news.asp?ID=<%=newID%>"> >> <%=newTitle%></a>
