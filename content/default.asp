...
<%if catid=nil or subcatid=nil then
	Response.Redirect("../default.asp")
else
	if subcattitle(cid,sid)=nil or textdescr(cid,sid)=nil then
%>
<script>
	history.back()
</script>
...
<FORM method="POST" action="../netCom/default.asp" name=form1 id=form1 onSubmit="return checkFields(this)">									
