...
<table cellpadding="0" cellspacing="0" width="160" ID="Table1">
<tr><td  align=center>
<table WIDTH="90%" ALIGN="center" BORDER="0" CELLPADDING="0" cellspacing="1">	
	 <tr><td nowrap height="10"></td></tr>	
	<tr>		
		<td width=100%  valign=top align="right" dir="rtl" style="FONT-FAMILY: Arial; FONT-SIZE: 10.5pt; FONT-WEIGHT: normal; color: #00437a; "><%=Server.HTMLEncode("אנו מודים לך על פנייתך לחברת פגסוס.") %>
		</td>
	</tr>	
	 <tr><td nowrap height="3"></td></tr>		
	<tr>		
		<td width=100%  valign=top align="right" dir="rtl" style="FONT-FAMILY: Arial; FONT-SIZE: 10.5pt; FONT-WEIGHT: normal; color: #00437a; "><%=Server.HTMLEncode("נציגנו יצרו עמך קשר בהקדם האפשרי.") %>
		</td>
	</tr>	
	 <tr><td nowrap height="10"></td></tr>			
</table>
